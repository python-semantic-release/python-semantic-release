...
* fix: remove comments and bump isort in workflow ([`b963e0d`](https://github.com/bernardcooke53/python-semantic-release/commit/b963e0d39d37bc7e9ca32b7f9f4f8eb6a807c28a))
...
Use a [=:] group instead of running two separate searches. ([`bbaf6b9`](https://github.com/bernardcooke53/python-semantic-release/commit/bbaf6b926532314c41c733be24847a6ab5686a74))

### Style

* style: improve code formatting ([`0a4d8ba`](https://github.com/bernardcooke53/python-semantic-release/commit/0a4d8ba209c8fad7f254278e8bb382505885741d))

* style: improve code formatting ([`149e426`](https://github.com/bernardcooke53/python-semantic-release/commit/149e426c7bf70482e14e41c69f96236090df7ed5))

### Unknown

* 6.1.0

Automatically generated by python-semantic-release ([`5cbd21d`](https://github.com/bernardcooke53/python-semantic-release/commit/5cbd21d99ede848643df1b2ce4517c27ed83d80e))
...
This was missed in 213530fb0c914e274b81d1dacf38ea7322b5b91f ([`3084249`](https://github.com/bernardcooke53/python-semantic-release/commit/308424933fd3375ca3730d9eaf8abbad2435830b))

### Unknown

* 6.0.1

Automatically generated by python-semantic-release ([`c0ddaaa`](https://github.com/bernardcooke53/python-semantic-release/commit/c0ddaaaf137f65353e5e00d1f9cbbcb74622dfd4))
...
`--verbosity DEBUG`. ([`15b1f65`](https://github.com/bernardcooke53/python-semantic-release/commit/15b1f650f29761e1ab2a91b767cbff79b2057a4c))
...
dependencies are included as extras. ([`401468f`](https://github.com/bernardcooke53/python-semantic-release/commit/401468f312cf4f3b52006c68c58c4645b5e19802))

### Chore

* chore(tox): clean up tox.ini

Allow mypy and coverage to run on any Python version. ([`28feba6`](https://github.com/bernardcooke53/python-semantic-release/commit/28feba6801315422f492b38b2299a283fb7a3462))
...
new version to be pushed. ([`6c98aab`](https://github.com/bernardcooke53/python-semantic-release/commit/6c98aab932724e3aab08e68b75439bc8c31bd877))

* ci: cache testing dependencies

This should help improve the speed of the testing workflow by caching 
downloaded dependencies. ([`4f53e35`](https://github.com/bernardcooke53/python-semantic-release/commit/4f53e351960a6b658f50265384c9e8f678718f68))

* ci: move beautification to separate workflow

See https://github.com/relekang/python-semantic-release/pull/214#issuecomment-613916623 ([`6ed42dc`](https://github.com/bernardcooke53/python-semantic-release/commit/6ed42dc83027f48865e4309d520c8b6654b88058))

* ci: beautify code automatically (#214)

Run isort and Black on pushes to master. Any edits made are committed. isort and flake8 no longer run as a check. ([`d49c4ac`](https://github.com/bernardcooke53/python-semantic-release/commit/d49c4ac8d0eb6086693dfbd3e06c63d7e9b5d94c))

### Documentation

* docs: create Read the Docs config file ([`aa5a1b7`](https://github.com/bernardcooke53/python-semantic-release/commit/aa5a1b700a1c461c81c6434686cb6f0504c4bece))

* docs: include README.rst in index.rst

These files were very similar so it makes sense to simply include one 
inside the other. ([`8673a9d`](https://github.com/bernardcooke53/python-semantic-release/commit/8673a9d92a9bf348bb3409e002a830741396c8ca))

* docs: rewrite README.rst ([`e049772`](https://github.com/bernardcooke53/python-semantic-release/commit/e049772cf14cdd49538cf357db467f0bf3fe9587))

* docs: move action.rst into main documentation ([`509ccaf`](https://github.com/bernardcooke53/python-semantic-release/commit/509ccaf307a0998eced69ad9fee1807132babe28))

* docs: rewrite troubleshooting page ([`0285de2`](https://github.com/bernardcooke53/python-semantic-release/commit/0285de215a8dac3fcc9a51f555fa45d476a56dff))

### Refactor

* refactor(debug): improve debug output ([`213530f`](https://github.com/bernardcooke53/python-semantic-release/commit/213530fb0c914e274b81d1dacf38ea7322b5b91f))

### Style

* style: improve code formatting ([`a8fdab5`](https://github.com/bernardcooke53/python-semantic-release/commit/a8fdab5b9dbc3dbf092181f30edbdd626a8f668c))

* style: improve code formatting ([`d1efc22`](https://github.com/bernardcooke53/python-semantic-release/commit/d1efc22605b06e8901e82d7ddb865ef69f143c54))

### Unknown

* 6.0.0

Automatically generated by python-semantic-release ([`bcafa28`](https://github.com/bernardcooke53/python-semantic-release/commit/bcafa284da51938c2ef7a9d4aa43ad5b839d57d6))

* doc: updated doc with new ParsedCommit object instead of nested Tuple ([`ac565dc`](https://github.com/bernardcooke53/python-semantic-release/commit/ac565dc824ea575e8899b932db148ac28e27fce2))
...
default. ([`a02a9b7`](https://github.com/bernardcooke53/python-semantic-release/commit/a02a9b7e34d8e7f8bb3b9c8aa1b5e1ef8bdd406c))

* ci: run tests on pull_request

The tests didn&#39;t run for #211 which caused a flake8 failure to be 
missed. ([`32fd77e`](https://github.com/bernardcooke53/python-semantic-release/commit/32fd77ed835bcfc943abeacec4e327df045b2ec9))

* ci: run tests on GitHub Actions ([`39ff283`](https://github.com/bernardcooke53/python-semantic-release/commit/39ff283312a0c686bfc5be71e1da9b6456652d95))

### Documentation

* docs: automate API docs

Automatically create pages in the API docs section using sphinx-autodoc. This is added as an event handler in conf.py. ([`7d4fea2`](https://github.com/bernardcooke53/python-semantic-release/commit/7d4fea266cc75007de51609131eb6d1e324da608))

### Feature

* feat(github): add tag as default release name ([`2997908`](https://github.com/bernardcooke53/python-semantic-release/commit/2997908f80f4fcec56917d237a079b961a06f990))

### Refactor

* refactor(vcs): add functools.wraps to check_repo ([`4d97187`](https://github.com/bernardcooke53/python-semantic-release/commit/4d971873669d7ed5427108b180cbd5530375d8f3))
...
#211. ([`172391e`](https://github.com/bernardcooke53/python-semantic-release/commit/172391ec5b5e490081b9b0ea58a94dfd5be33937))

### Unknown

* 5.2.0

Automatically generated by python-semantic-release ([`3bd3255`](https://github.com/bernardcooke53/python-semantic-release/commit/3bd3255fc1aafc9312c125b7aaefaa1ffb10c0dc))
...
* chore(github): create issue templates ([`0f57662`](https://github.com/bernardcooke53/python-semantic-release/commit/0f57662ce7f6ce540b80aa7ad857bcc24edbc897))

### Documentation

* docs: update index.rst ([`b27c26c`](https://github.com/bernardcooke53/python-semantic-release/commit/b27c26c66e7e41843ab29076f7e724908091b46e))

* docs: improve formatting of envvars page ([`b376a56`](https://github.com/bernardcooke53/python-semantic-release/commit/b376a567bfd407a507ce0752614b0ca75a0f2973))

* docs: improve formatting of configuration page ([`9a8e22e`](https://github.com/bernardcooke53/python-semantic-release/commit/9a8e22e838d7dbf3bfd941397c3b39560aca6451))

### Feature

* feat(history): allow customizing changelog_sections (#207) ([`d5803d5`](https://github.com/bernardcooke53/python-semantic-release/commit/d5803d5c1668d86482a31ac0853bac7ecfdc63bc))

### Unknown

* 5.1.0

Automatically generated by python-semantic-release ([`af24bc2`](https://github.com/bernardcooke53/python-semantic-release/commit/af24bc27e84d9728ae55612e2e78855bf410e549))
...
* chore: isort errors ([`0a6f8c3`](https://github.com/bernardcooke53/python-semantic-release/commit/0a6f8c3842b05f5f424dad5ce1fa5e3823c7e688))
...
&#39;descriptions&#39; instead of confusing numeric indices. ([`bff40d5`](https://github.com/bernardcooke53/python-semantic-release/commit/bff40d53174ffe27451d82132c31b112c7bee9fd))

### Unknown

* 5.0.3

Automatically generated by python-semantic-release ([`169afc6`](https://github.com/bernardcooke53/python-semantic-release/commit/169afc60010743db81d86f23dd0d3b40a0f9af4a))
...
Previously, use of str.capitalize() would capitalize the first letter as expected, but all subsequent letters became lowercase. Now, the other letters remain unchanged. ([`96ba94c`](https://github.com/bernardcooke53/python-semantic-release/commit/96ba94c4b4593997343ec61ecb6c823c1494d0e2))

### Test

* test: Run --help in docker image to make testing of image easier ([`b41e6b2`](https://github.com/bernardcooke53/python-semantic-release/commit/b41e6b27d63321bba8a6bb717de734df300ee1cc))

### Unknown

* 5.0.2

Automatically generated by python-semantic-release ([`3baf55b`](https://github.com/bernardcooke53/python-semantic-release/commit/3baf55bf425b340e1be12a70868526066c9708b6))
...
will get the version they specify. ([`123984d`](https://github.com/bernardcooke53/python-semantic-release/commit/123984d735181c622f3d99088a1ad91321192a11))

### Unknown

* 5.0.1

Automatically generated by python-semantic-release ([`3c0a79c`](https://github.com/bernardcooke53/python-semantic-release/commit/3c0a79c5bb019782da55be9bbe5fc3241269a621))
...
* docs(pypi): update docstings in pypi.py ([`6502d44`](https://github.com/bernardcooke53/python-semantic-release/commit/6502d448fa65e5dc100e32595e83fff6f62a881a))
...
Closes #188 ([`740f4bd`](https://github.com/bernardcooke53/python-semantic-release/commit/740f4bdb26569362acfc80f7e862fc2c750a46dd))

### Fix

* fix: Rename default of build_command config ([`d5db22f`](https://github.com/bernardcooke53/python-semantic-release/commit/d5db22f9f7acd05d20fd60a8b4b5a35d4bbfabb8))

### Refactor

* refactor(cli): improve readability of cli.py and some log messages ([`646dd81`](https://github.com/bernardcooke53/python-semantic-release/commit/646dd81944bad27f5defe4a33b0ebeb5c9ed0c4e))

* refactor: make check_repo a decorator ([`3799d8b`](https://github.com/bernardcooke53/python-semantic-release/commit/3799d8b595d0b36e59e5486c9b5f1070a47f3903))

### Style

* style: improve readability of history/__init__.py ([`c878cd3`](https://github.com/bernardcooke53/python-semantic-release/commit/c878cd3eb84fe8776913d082270720d4209e6007))

* style: improve readability of parsers ([`f84f317`](https://github.com/bernardcooke53/python-semantic-release/commit/f84f31754240212822227f6880ff110a8dd95214))

* style: improve readability of history/logs.py ([`2f22892`](https://github.com/bernardcooke53/python-semantic-release/commit/2f228921d30e6664986e1ab5a5e840297f52e2f0))

* style: improve readability of vcs_helpers.py ([`e46a358`](https://github.com/bernardcooke53/python-semantic-release/commit/e46a35833c816e570ceea9d67297a725b8ffc9ff))

* style: improve readability of settings.py ([`af4df82`](https://github.com/bernardcooke53/python-semantic-release/commit/af4df82603d9aac70e47672f196a0a5e5160f817))

### Unknown

* 5.0.0

Automatically generated by python-semantic-release ([`63db9d3`](https://github.com/bernardcooke53/python-semantic-release/commit/63db9d3f3dbe89a42d1d87aaaa068004a5b32b39))
...
* ci: use GitHub Action from this repo ([`4352ea8`](https://github.com/bernardcooke53/python-semantic-release/commit/4352ea8d116abcd5d6c86e897b8d2d5ef72bd663))

* ci: store PyPI username in secrets ([`b6de1a6`](https://github.com/bernardcooke53/python-semantic-release/commit/b6de1a6324ebe3ad6bd8735e16711877e773fea8))

* ci: set up releasing with GitHub Actions

#109: Setup github actions for releasing this project by calling on the current source code. ([`a80cc45`](https://github.com/bernardcooke53/python-semantic-release/commit/a80cc45df47cba6e730afc3c80d959fcba56485c))

### Documentation

* docs: make AUTHORS.rst dynamic ([`db2e076`](https://github.com/bernardcooke53/python-semantic-release/commit/db2e0762f3189d0f1a6ba29aad32bdefb7e0187f))

* docs(readme): fix minor typo ([`c22f69f`](https://github.com/bernardcooke53/python-semantic-release/commit/c22f69f62a215ff65e1ab6dcaa8e7e9662692e64))

### Feature

* feat(actions): create GitHub Action ([`350245d`](https://github.com/bernardcooke53/python-semantic-release/commit/350245dbfb07ed6a1db017b1d9d1072b368b1497))

### Unknown

* 4.11.0

Automatically generated by python-semantic-release ([`5a63c20`](https://github.com/bernardcooke53/python-semantic-release/commit/5a63c20b0d47531a170dd2df0975ba4db4b32d6f))
...
* feat: make commit message configurable (#184) ([`eb0762c`](https://github.com/bernardcooke53/python-semantic-release/commit/eb0762ca9fea5cecd5c7b182504912a629be473b))

### Unknown

* 4.10.0

Automatically generated by python-semantic-release ([`7278dcf`](https://github.com/bernardcooke53/python-semantic-release/commit/7278dcf1bdb3c6be8b122e41f55e3127b89335b0))
...
Add a config option to set the commands passed to setup.py when building distributions. This allows for things like adding custom commands to the build process. ([`22146ea`](https://github.com/bernardcooke53/python-semantic-release/commit/22146ea4b94466a90d60b94db4cc65f46da19197))

### Fix

* fix(pypi): change bdist_wheels to bdist_wheel

Change the incorrect command bdist_wheels to bdist_wheel. ([`c4db509`](https://github.com/bernardcooke53/python-semantic-release/commit/c4db50926c03f3d551c8331932c567c7bdaf4f3d))

### Unknown

* 4.9.0

Automatically generated by python-semantic-release ([`1b7f46c`](https://github.com/bernardcooke53/python-semantic-release/commit/1b7f46c73aa396377c144838518808907b5f1f9d))
...
* feat(git): Add a new config for commit author ([`aa2c22c`](https://github.com/bernardcooke53/python-semantic-release/commit/aa2c22c469448fe57f02bea67a02f998ce519ac3))

### Unknown

* 4.8.0

Automatically generated by python-semantic-release ([`0e9da39`](https://github.com/bernardcooke53/python-semantic-release/commit/0e9da39f8007ff439d843fe4f1f5e0139cc12174))
...
Fixes #181 ([`0fddbe2`](https://github.com/bernardcooke53/python-semantic-release/commit/0fddbe2fb70d24c09ceddb789a159162a45942dc))

### Unknown

* 4.7.1

Automatically generated by python-semantic-release ([`52e3022`](https://github.com/bernardcooke53/python-semantic-release/commit/52e3022025d49006f5c0bfe15bb14b34c2a4cb64))
...
Post the changelog in-between uploading to PyPI and uploading to GitHub Releases. This is so that if the PyPI upload fails, GitHub users will not be notified. GitHub uploads still need to be processed after creating the changelog as the release notes must be published to upload assets to them. ([`e427658`](https://github.com/bernardcooke53/python-semantic-release/commit/e427658e33abf518191498c3142a0f18d3150e07))

### Fix

* fix: support repository owner names containing dots

Fixes #179 ([`a6c4da4`](https://github.com/bernardcooke53/python-semantic-release/commit/a6c4da4c0e6bd8a37f64544f7813fa027f5054ed))

* fix(github): use application/octet-stream for .whl files

application/octet-stream is more generic, but it is better than using a non-official MIME type. ([`90a7e47`](https://github.com/bernardcooke53/python-semantic-release/commit/90a7e476a04d26babc88002e9035cad2ed485b07))

### Unknown

* 4.7.0

Automatically generated by python-semantic-release ([`e32e4aa`](https://github.com/bernardcooke53/python-semantic-release/commit/e32e4aa01beb5b322d04d07209ce28b07b5ad892))
...
whether they are capitalized in the commit itself. ([`1a8e306`](https://github.com/bernardcooke53/python-semantic-release/commit/1a8e3060b8f6d6362c27903dcfc69d17db5f1d36))

### Fix

* fix: Only overwrite with patch if bump is None

Fixes #159 ([`1daa4e2`](https://github.com/bernardcooke53/python-semantic-release/commit/1daa4e23ec2dd40c6b490849276524264787e24e))

* fix: Add more debug statements in logs ([`bc931ec`](https://github.com/bernardcooke53/python-semantic-release/commit/bc931ec46795fde4c1ccee004eec83bf73d5de7a))

### Refactor

* refactor(history): remove unnecessary newlines

Since simplifying the capitalization, the comment is no longer needed and so the statement can be compacted onto one line again. ([`ffc3f8b`](https://github.com/bernardcooke53/python-semantic-release/commit/ffc3f8bada5f9a031ffe3af1e00c01b0edb05740))

* refactor(history): use capitalize method for readability

Co-Authored-By: Rolf Erik Lekang &lt;me@rolflekang.com&gt; ([`289349a`](https://github.com/bernardcooke53/python-semantic-release/commit/289349a314f63069ff6f7e40a9d0f2bf0f6063cf))

### Unknown

* 4.6.0

Automatically generated by python-semantic-release ([`5723267`](https://github.com/bernardcooke53/python-semantic-release/commit/5723267e331359958f5d6753a4419ea393cf7eb6))
...
Fix the syntax of a broken bullet-point list in README.rst. ([`7aa572b`](https://github.com/bernardcooke53/python-semantic-release/commit/7aa572b2a323ddbc69686309226395f40c52b469))

* docs: Add note about automatic releases in readme ([`e606e75`](https://github.com/bernardcooke53/python-semantic-release/commit/e606e7583a30167cf7679c6bcada2f9e768b3abe))

* docs: Update readme and getting started docs ([`07b3208`](https://github.com/bernardcooke53/python-semantic-release/commit/07b3208ff64301e544c4fdcb48314e49078fc479))
...
Fixes relekang/python-semantic-release#167 ([`be9972a`](https://github.com/bernardcooke53/python-semantic-release/commit/be9972a7b1fb183f738fb31bd370adb30281e4d5))

### Unknown

* 4.5.1

Automatically generated by python-semantic-release ([`4151215`](https://github.com/bernardcooke53/python-semantic-release/commit/415121511074dbda8cff94bba562b773c1674809))
...
Closes #165 ([`7837f50`](https://github.com/bernardcooke53/python-semantic-release/commit/7837f5036269328ef29996b9ea63cccd5a6bc2d5))

### Fix

* fix: Remove erroneous submodule ([`762bfda`](https://github.com/bernardcooke53/python-semantic-release/commit/762bfda728c266b8cd14671d8da9298fc99c63fb))
...
Closes #73 ([`4fcc781`](https://github.com/bernardcooke53/python-semantic-release/commit/4fcc781d1a3f9235db552f0f4431c9f5e638d298))

### Unknown

* 4.5.0

Automatically generated by python-semantic-release ([`13bb275`](https://github.com/bernardcooke53/python-semantic-release/commit/13bb27534e95b245ebbe4b8a86b1cb1da8afba00))
...
Fixes #163 ([`46a83a9`](https://github.com/bernardcooke53/python-semantic-release/commit/46a83a94b17c09d8f686c3ae7b199d7fd0e0e5e5))

### Unknown

* 4.4.1

Automatically generated by python-semantic-release ([`29c70c6`](https://github.com/bernardcooke53/python-semantic-release/commit/29c70c641b7c799913482a20dffe0638dc599a53))
...
didn&#39;t updated parser_tag since it looks like a legacy parser. ([`beedccf`](https://github.com/bernardcooke53/python-semantic-release/commit/beedccfddfb360aeebef595342ee980446012ec7))
...
Fixes #156 ([`a4f8a10`](https://github.com/bernardcooke53/python-semantic-release/commit/a4f8a10afcc358a8fbef83be2041129480350be2))

### Fix

* fix(github): add check for GITHUB_ACTOR for git push (#162) ([`c41e9bb`](https://github.com/bernardcooke53/python-semantic-release/commit/c41e9bb986d01b92d58419cbdc88489d630a11f1))

### Unknown

* 4.4.0

Automatically generated by python-semantic-release ([`8a7ca61`](https://github.com/bernardcooke53/python-semantic-release/commit/8a7ca61caf53a9ca8b65e7acafb47db8ef7c77f3))
...
Fixes #51 ([`252bffd`](https://github.com/bernardcooke53/python-semantic-release/commit/252bffd3be7b6dfcfdb384d24cb1cd83d990fc9a))

### Unknown

* 4.3.4

Automatically generated by python-semantic-release ([`16f1e3f`](https://github.com/bernardcooke53/python-semantic-release/commit/16f1e3fdfd6b346cf3169fedbff2021bca8d37f8))
...
* The string template has no variables, so remove the call to .format() ([`f07c7f6`](https://github.com/bernardcooke53/python-semantic-release/commit/f07c7f653be1c018e443f071d9a196d9293e9521))

### Unknown

* 4.3.3

Automatically generated by python-semantic-release ([`9551e3e`](https://github.com/bernardcooke53/python-semantic-release/commit/9551e3e8a289f845589f5c2d342901ea9a830bbb))
...
Fixes #151 ([`2778e31`](https://github.com/bernardcooke53/python-semantic-release/commit/2778e316a0c0aa931b1012cb3862d04659c05e73))

### Unknown

* 4.3.2

Automatically generated by python-semantic-release ([`0f38993`](https://github.com/bernardcooke53/python-semantic-release/commit/0f38993ee0ae2cd269cdb05d969ca8bad194e997))
...
* fix: support repo urls without git terminator ([`700e9f1`](https://github.com/bernardcooke53/python-semantic-release/commit/700e9f18dafde1833f482272a72bb80b54d56bb3))

### Test

* test: better test coverage

Adds some coverage mainly on cli and vcs_helpers ([`b7bf6fe`](https://github.com/bernardcooke53/python-semantic-release/commit/b7bf6fe4ea0f1d11e56ec6e39a242253061dc5fc))

### Unknown

* 4.3.1

Automatically generated by python-semantic-release ([`1da943f`](https://github.com/bernardcooke53/python-semantic-release/commit/1da943f78280e01d4f5f91786996a658492957ea))
...
Fixes #104 ([`1f9fe1c`](https://github.com/bernardcooke53/python-semantic-release/commit/1f9fe1cc7666d47cc0c348c4705b63c39bf10ecc))
...
Fixes #121 ([`82d555d`](https://github.com/bernardcooke53/python-semantic-release/commit/82d555d45b9d9e295ef3f9546a6ca2a38ca4522e))
...
Fixes #119 ([`f0ac82f`](https://github.com/bernardcooke53/python-semantic-release/commit/f0ac82fe59eb59a768a73a1bf2ea934b9d448c58))
...
Relates to #119 ([`35f8bfe`](https://github.com/bernardcooke53/python-semantic-release/commit/35f8bfef443c8b69560c918f4b13bc766fb3daa2))
...
Fixes #145 ([`41ea12f`](https://github.com/bernardcooke53/python-semantic-release/commit/41ea12fa91f97c0046178806bce3be57c3bc2308))
...
Fixes #139
Fixes #140 ([`4b11875`](https://github.com/bernardcooke53/python-semantic-release/commit/4b118754729094e330389712cf863e1c6cefee69))

### Unknown

* 4.3.0

Automatically generated by python-semantic-release ([`24336d4`](https://github.com/bernardcooke53/python-semantic-release/commit/24336d43f6e69ef1216d56b47892ee864af09c7d))
...
* chore: Add tools requirements file ([`bbf1109`](https://github.com/bernardcooke53/python-semantic-release/commit/bbf110913cfe323bf174986fe7f4b38d88e41bd6))

* chore: Remove tox and mypy from dev requirements ([`9dcfaf0`](https://github.com/bernardcooke53/python-semantic-release/commit/9dcfaf05ee1f8055221d1959ca1accb1017e2d53))

### Feature

* feat: Add support for showing unreleased changelog

Fixes #134 ([`41ef794`](https://github.com/bernardcooke53/python-semantic-release/commit/41ef7947ad8a07392c96c7540980476e989c1d83))

* feat: Add support for configuring branch

Fixes #43 ([`14abb05`](https://github.com/bernardcooke53/python-semantic-release/commit/14abb05e7f878e88002f896812d66b4ea5c219d4))

* feat: Add configuration to customize handling of dists

Relates to #115 ([`2af6f41`](https://github.com/bernardcooke53/python-semantic-release/commit/2af6f41b21205bdd192514a434fca2feba17725a))

### Fix

* fix: Remove deletion of build folder

Fixes #115 ([`b45703d`](https://github.com/bernardcooke53/python-semantic-release/commit/b45703dad38c29b28575060b21e5fb0f8482c6b1))

* fix: updated the tag tests ([`3303eef`](https://github.com/bernardcooke53/python-semantic-release/commit/3303eefa49a0474bbd85df10ae186ccbf9090ec1))

* fix: kept setting new version for tag source ([`0e24a56`](https://github.com/bernardcooke53/python-semantic-release/commit/0e24a5633f8f94b48da97b011634d4f9d84f7b4b))

* fix: Add commit hash when generating breaking changes

Fixes #120 ([`0c74faf`](https://github.com/bernardcooke53/python-semantic-release/commit/0c74fafdfa81cf2e13db8f4dcf0a6f7347552504))

* fix: Upgrade click to 7.0 ([`2c5dd80`](https://github.com/bernardcooke53/python-semantic-release/commit/2c5dd809b84c2157a5e6cdcc773c43ec864f0328))

### Test

* test: Fix test name ([`aff4454`](https://github.com/bernardcooke53/python-semantic-release/commit/aff4454aa329bcab54b969ed0c41ed429a9b5683))

* test: Add mocking of reading of repo owner

Fixes #108 ([`04cc6b5`](https://github.com/bernardcooke53/python-semantic-release/commit/04cc6b5af969275b1096cbf45f9dc03a105d7034))

### Unknown

* 4.2.0

Automatically generated by python-semantic-release ([`ef96209`](https://github.com/bernardcooke53/python-semantic-release/commit/ef96209fd54a095343e2cdf8f70f3c0b3ac8b998))
...
* docs(circleci): point badge to master branch ([`9c7302e`](https://github.com/bernardcooke53/python-semantic-release/commit/9c7302e184a1bd88f39b3039691b55cd77f0bb07))

### Fix

* fix: Make sure the history only breaks loop for version commit

Fixes #135 ([`5dc6cfc`](https://github.com/bernardcooke53/python-semantic-release/commit/5dc6cfc634254f09997bb3cb0f17abd296e2c01f))

* fix: correct isort build fail

build fail:  https://circleci.com/gh/relekang/python-semantic-release/379 ([`0037210`](https://github.com/bernardcooke53/python-semantic-release/commit/00372100b527ff9308d9e43fe5c65cdf179dc4dc))

* fix(vcs): allow cli to be run from subdirectory ([`fb7bb14`](https://github.com/bernardcooke53/python-semantic-release/commit/fb7bb14300e483626464795b8ff4f033a194cf6f))

### Unknown

* 4.1.2

Automatically generated by python-semantic-release ([`07f999a`](https://github.com/bernardcooke53/python-semantic-release/commit/07f999a934dfb31657656498ab2f720471b851b6))

* Fix minor sematic typo ([`76123f4`](https://github.com/bernardcooke53/python-semantic-release/commit/76123f410180599a19e7c48da413880185bbea20))
...
Should be ignored in git as well. ([`ff58962`](https://github.com/bernardcooke53/python-semantic-release/commit/ff5896242a65c3f6d897eb911137956175d74ebd))

* chore: ignore vscode settings ([`bf9da4c`](https://github.com/bernardcooke53/python-semantic-release/commit/bf9da4ca9754c21d69598d956664e2fa3e6b9d5e))
...
environment variables as well. ([`f08e594`](https://github.com/bernardcooke53/python-semantic-release/commit/f08e5943a9876f2d17a7c02f468720995c7d9ffd))

* docs: correct usage of changelog ([`f4f59b0`](https://github.com/bernardcooke53/python-semantic-release/commit/f4f59b08c73700c6ee04930221bfcb1355cbc48d))

* docs: describing the commands

The commands is lacking from the documentation. ([`b6fa04d`](https://github.com/bernardcooke53/python-semantic-release/commit/b6fa04db3044525a1ee1b5952fb175a706842238))

* docs: update url for commit guidelinesThe guidelines can now be found in theDEVELOPERS.md in angular. ([`90c1b21`](https://github.com/bernardcooke53/python-semantic-release/commit/90c1b217f86263301b91d19d641c7b348e37d960))
...
module did not have any debug ([`0c6237b`](https://github.com/bernardcooke53/python-semantic-release/commit/0c6237bc01ec39608fb768925091c755d9bb25bd))

* refactor: fix import sorting ([`01e4c5d`](https://github.com/bernardcooke53/python-semantic-release/commit/01e4c5d743f2f237d2c85481118e467d4f5fde15))

* refactor: add debug output ([`06f3788`](https://github.com/bernardcooke53/python-semantic-release/commit/06f378819fea7c007176f0950db33b3d485a246a))

### Unknown

* 4.1.1

Automatically generated by python-semantic-release ([`84d053f`](https://github.com/bernardcooke53/python-semantic-release/commit/84d053f424c4ea7cd03fde60e7922472dc84edd3))
...
* docs(readme): add testing instructions ([`bb352f5`](https://github.com/bernardcooke53/python-semantic-release/commit/bb352f5b6616cc42c9f2f2487c51dedda1c68295))

* docs: Add installation instructions for development (#106) ([`9168d0e`](https://github.com/bernardcooke53/python-semantic-release/commit/9168d0ea56734319a5d77e890f23ff6ba51cc97d))

### Feature

* feat(ci_checks): add support for bitbucket ([`9fc120d`](https://github.com/bernardcooke53/python-semantic-release/commit/9fc120d1a7e4acbbca609628e72651685108b364))
...
I am using python-semantic-release with a Julia project and this change will allow for consistent formatting in my Project.toml file where the version is maintained ([`bf63156`](https://github.com/bernardcooke53/python-semantic-release/commit/bf63156f60340614fae94c255fb2f097cf317b2b))

* fix: initialize git Repo from current folder

This allows to run the program also from inner repository folders ([`c7415e6`](https://github.com/bernardcooke53/python-semantic-release/commit/c7415e634c0affbe6396e0aa2bafe7c1b3368914))

* fix: Use same changelog code for command as post

See #27 for background. ([`248f622`](https://github.com/bernardcooke53/python-semantic-release/commit/248f62283c59182868c43ff105a66d85c923a894))

### Unknown

* 4.1.0

Automatically generated by python-semantic-release ([`c5dbbc9`](https://github.com/bernardcooke53/python-semantic-release/commit/c5dbbc96ec073b939daae92da3e82ef411a17ccb))

* 4.0.2

Automatically generated by python-semantic-release ([`f008fdb`](https://github.com/bernardcooke53/python-semantic-release/commit/f008fdb9bcb727df7fb37402b3228dd38f3bc5ac))

* Merge pr #89

This was merged locally to fix conflicts. ([`0dad451`](https://github.com/bernardcooke53/python-semantic-release/commit/0dad451617cc752ad3830c9442cf0b0e0993a454))
...
Fixes #90 ([`896e37b`](https://github.com/bernardcooke53/python-semantic-release/commit/896e37b95cc43218e8f593325dd4ea63f8b895d9))

### Fix

* fix: Use correct syntax to exclude tests in package

This implements #92 without deleting __init__.py files. ([`3e41e91`](https://github.com/bernardcooke53/python-semantic-release/commit/3e41e91c318663085cd28c8165ece21d7e383475))

* fix: Filter out pypi secrets from exceptions

Fixes #41 ([`5918371`](https://github.com/bernardcooke53/python-semantic-release/commit/5918371c1e82b06606087c9945d8eaf2604a0578))

* fix: Clean out dist and build before building

This should fix the problem with uploading old versions.

Fixes #86 ([`b628e46`](https://github.com/bernardcooke53/python-semantic-release/commit/b628e466f86bc27cbe45ec27a02d4774a0efd3bb))

* fix: Add better error message when pypi credentials are empty

Fixes #96 ([`c4e5dcb`](https://github.com/bernardcooke53/python-semantic-release/commit/c4e5dcbeda0ce8f87d25faefb4d9ae3581029a8f))

* fix: Unfreeze dependencies

This uses ~= for most dependencies instead of pinning them.

Fixes #100 ([`847833b`](https://github.com/bernardcooke53/python-semantic-release/commit/847833bf48352a4935f906d0c3f75e1db596ca1c))

* fix(parser_angular): Fix non-match when special chars in scope ([`8a33123`](https://github.com/bernardcooke53/python-semantic-release/commit/8a331232621b26767e4268079f9295bf695047ab))

### Test

* test: Update test after adding cleaning of dist ([`202fba5`](https://github.com/bernardcooke53/python-semantic-release/commit/202fba50c287d3df99b22a4f30a96a3d8d9c8141))

* test(angular): Fix pep8 violations ([`a504f26`](https://github.com/bernardcooke53/python-semantic-release/commit/a504f262a05dc27b87e2c766f185b17cd8b39765))

### Unknown

* 4.0.1

Automatically generated by python-semantic-release ([`af624a2`](https://github.com/bernardcooke53/python-semantic-release/commit/af624a2eda375cf83494df4da9f5af137c6ec1d2))
...
BREAKING CHANGE: This will only work with python 3 after this commit. ([`85fe638`](https://github.com/bernardcooke53/python-semantic-release/commit/85fe6384c15db317bc7142f4c8bbf2da58cece58))
...
re #88 #32 ([`4de5400`](https://github.com/bernardcooke53/python-semantic-release/commit/4de540011ab10483ee1865f99c623526cf961bb9))
...
re #81 ([`a6d5e9b`](https://github.com/bernardcooke53/python-semantic-release/commit/a6d5e9b1ccbe75d59e7240528593978a19d8d040))
...
was meant to be written. ([`da6844b`](https://github.com/bernardcooke53/python-semantic-release/commit/da6844bce0070a0020bf13950bd136fe28262602))
...
Closes #88  re #32 ([`8df5e2b`](https://github.com/bernardcooke53/python-semantic-release/commit/8df5e2bdd33a620e683f3adabe174e94ceaa88d9))

### Fix

* fix: Add credentials check ([`0694604`](https://github.com/bernardcooke53/python-semantic-release/commit/0694604f3b3d2159a4037620605ded09236cdef5))

* fix: Add check of credentials ([`7d945d4`](https://github.com/bernardcooke53/python-semantic-release/commit/7d945d44b36b3e8c0b7771570cb2305e9e09d0b2))

* fix: Add dists to twine call ([`1cec2df`](https://github.com/bernardcooke53/python-semantic-release/commit/1cec2df8bcb7f877c813d6470d454244630b050a))

* fix: Re-add skip-existing ([`366e9c1`](https://github.com/bernardcooke53/python-semantic-release/commit/366e9c1d0b9ffcde755407a1de18e8295f6ad3a1))

* fix: Use twine through cli call ([`ab84beb`](https://github.com/bernardcooke53/python-semantic-release/commit/ab84beb8f809e39ae35cd3ce5c15df698d8712fd))

* fix: Use new interface for twine ([`c04872d`](https://github.com/bernardcooke53/python-semantic-release/commit/c04872d00a26e9bf0f48eeacb360b37ce0fba01e))

* fix: Remove repository argument in twine ([`e24543b`](https://github.com/bernardcooke53/python-semantic-release/commit/e24543b96adb208897f4ce3eaab96b2f4df13106))

* fix: Update twine ([`c4ae7b8`](https://github.com/bernardcooke53/python-semantic-release/commit/c4ae7b8ecc682855a8568b247690eaebe62d2d26))

* fix: Remove universal from setup config ([`18b2402`](https://github.com/bernardcooke53/python-semantic-release/commit/18b24025e397aace03dd5bb9eed46cfdd13491bd))
...
* revert changes to vcs helpers ([`af3ad59`](https://github.com/bernardcooke53/python-semantic-release/commit/af3ad59f018876e11cc3acdda0b149f8dd5606bd))

### Refactor

* refactor: Fix typing errors ([`5c37d47`](https://github.com/bernardcooke53/python-semantic-release/commit/5c37d477053f3bf25b858c80ef176dada8110e7e))

### Style

* style(vcs_helpers): Add r prefix to regular expression match string

This &#39;raw&#39; designator gets rid of flake8 complaints ([`29c25d3`](https://github.com/bernardcooke53/python-semantic-release/commit/29c25d34f61ae4c2058ffc3ae4219ae6ad8b2775))

### Test

* test: Fix tests ([`d3862e8`](https://github.com/bernardcooke53/python-semantic-release/commit/d3862e890f27d11ba4978de3f79746873731001a))

### Unknown

* 4.0.0

Automatically generated by python-semantic-release ([`cf3f922`](https://github.com/bernardcooke53/python-semantic-release/commit/cf3f922d8ecad4f3f2f896919a620a39868fac59))

* Typo, link broken

Change `.. _angular commit guidelins:` to `.. _angular commit guidelines:` ([`721a6dd`](https://github.com/bernardcooke53/python-semantic-release/commit/721a6dd895aa5f0072fc76fe0325f23e565492c4))
...
* fix: Upgrade twine ([`9722313`](https://github.com/bernardcooke53/python-semantic-release/commit/9722313eb63c7e2c32c084ad31bed7ee1c48a928))

### Unknown

* 3.11.2 ([`762fbcf`](https://github.com/bernardcooke53/python-semantic-release/commit/762fbcfb72f3ed269eaa1bbb8b0de433166a0a47))
...
* chore: Divide circle ci into different jobs for better feedback on prs ([`11f7c8a`](https://github.com/bernardcooke53/python-semantic-release/commit/11f7c8a8d671e1e9d48c39c8876eee750e0406ec))

### Documentation

* docs: Add retry option to cli docs ([`021da50`](https://github.com/bernardcooke53/python-semantic-release/commit/021da5001934f3199c98d7cf29f62a3ad8c2e56a))

### Fix

* fix: change Gitpython version number

Change the Gitpython version number to fix a bug described in #80. ([`23c9d4b`](https://github.com/bernardcooke53/python-semantic-release/commit/23c9d4b6a1716e65605ed985881452898d5cf644))

### Unknown

* 3.11.1 ([`ddb3353`](https://github.com/bernardcooke53/python-semantic-release/commit/ddb3353876601b5bb39563a8fbcced63e9769c8d))
...
* chore: Replace travis and frigg with circleci ([`c53d11e`](https://github.com/bernardcooke53/python-semantic-release/commit/c53d11eaf897b5bbcf938bf32650f2a1ea227259))

### Documentation

* docs: Remove old notes about trello board ([`7f50c52`](https://github.com/bernardcooke53/python-semantic-release/commit/7f50c521a522bb0c4579332766248778350e205b))

* docs: Update status badges ([`cfa13b8`](https://github.com/bernardcooke53/python-semantic-release/commit/cfa13b8260e3f3b0bfcb395f828ad63c9c5e3ca5))
...
* Switch to ImproperConfigurationError ([`6786487`](https://github.com/bernardcooke53/python-semantic-release/commit/6786487ebf4ab481139ef9f43cd74e345debb334))
...
* Add comments
* Add --retry to the docs ([`3e312c0`](https://github.com/bernardcooke53/python-semantic-release/commit/3e312c0ce79a78d25016a3b294b772983cfb5e0f))

### Fix

* fix: Make repo non if it is not a git repository

Fixes #74 ([`1dc306b`](https://github.com/bernardcooke53/python-semantic-release/commit/1dc306b9b1db2ac360211bdc61fd815302d0014c))

* fix: Add pytest cache to gitignore ([`b8efd5a`](https://github.com/bernardcooke53/python-semantic-release/commit/b8efd5a6249c79c8378bffea3e245657e7094ec9))

### Style

* style: Fix flake8 ([`c9686a2`](https://github.com/bernardcooke53/python-semantic-release/commit/c9686a2edafbb23dbf0955f124d5d0b431bd4786))

* style: Fix flake8 ([`d9239ea`](https://github.com/bernardcooke53/python-semantic-release/commit/d9239ea32ffbce37e7c3b852a46660ea6aed75b9))

* style: Fix flake8 ([`a40f56f`](https://github.com/bernardcooke53/python-semantic-release/commit/a40f56f7774382a100f27aa824aef5a0ae796c9a))

* style: Fix isort warnings ([`5411c8d`](https://github.com/bernardcooke53/python-semantic-release/commit/5411c8d8b31229941fd32b0ffee937f4d36ff367))

### Test

* test: Fix broken tests and add a test after 3e312c0 ([`c3e0339`](https://github.com/bernardcooke53/python-semantic-release/commit/c3e0339c5d3d7ca05fef6714a91f1f321220785b))

### Unknown

* 3.11.0 ([`54e003c`](https://github.com/bernardcooke53/python-semantic-release/commit/54e003c8e9c358427067326a2507a279474761b7))
...
issue #74 ([`251b190`](https://github.com/bernardcooke53/python-semantic-release/commit/251b190a2fd5df68892346926d447cbc1b32475a))

### Unknown

* 3.10.3 ([`c15e0de`](https://github.com/bernardcooke53/python-semantic-release/commit/c15e0debb4dcdc7f15aa1ff6e1f23a99c83579a6))
...
* fix: update call to upload to work with twine 1.9.1 (#72) ([`8f47643`](https://github.com/bernardcooke53/python-semantic-release/commit/8f47643c54996e06c358537115e7e17b77cb02ca))

### Unknown

* 3.10.2 ([`0907db4`](https://github.com/bernardcooke53/python-semantic-release/commit/0907db4044e20895d1b9c4f9fb1de33a5d79c06e))
...
* chore: Fix config in travis ([`57e969f`](https://github.com/bernardcooke53/python-semantic-release/commit/57e969f8d937cc2335588f538bd8bc4aa522852a))

### Fix

* fix: Update Twine (#69)

The publishing API is under development and older versions of Twine have problems to deal with newer versions of the API. Namely the logic of register/upload has changed (it was simplified). ([`9f268c3`](https://github.com/bernardcooke53/python-semantic-release/commit/9f268c373a932621771abbe9607b739b1e331409))

### Unknown

* 3.10.1 ([`500972c`](https://github.com/bernardcooke53/python-semantic-release/commit/500972c0f9c0393a02bdfd8afea628772a0611c1))

* revert: &#34;chore: Remove travis&#34;

This reverts commit 93e5507da6d53ecf63405507390633ef480c52fb. ([`195ed8d`](https://github.com/bernardcooke53/python-semantic-release/commit/195ed8ddc004b736cd4e0301e5d7c7f6394cf4a5))
...
* chore: Remove a print statement ([`fe908d4`](https://github.com/bernardcooke53/python-semantic-release/commit/fe908d45048aecc4d4b94c7c8cb821bc941fe70c))

### Documentation

* docs: Fix typo in cli.py docstring (#64) ([`0d13985`](https://github.com/bernardcooke53/python-semantic-release/commit/0d139859cd71f2d483f4360f196d6ef7c8726c18))
...
Fix the test errors that would happen after the modification of get_commit_log. ([`628170e`](https://github.com/bernardcooke53/python-semantic-release/commit/628170ebc440fc6abf094dd3e393f40576dedf9b))

### Fix

* fix: Make changelog problems not fail whole publish

Can be fixed with changelog command later. ([`b5a68cf`](https://github.com/bernardcooke53/python-semantic-release/commit/b5a68cf6177dc0ed80eda722605db064f3fe2062))

### Test

* test: Make the tests green again ([`874307b`](https://github.com/bernardcooke53/python-semantic-release/commit/874307b5deb6c5a3fcb1212ab54dd81f49f8459e))

### Unknown

* 3.10.0 ([`7cfe01d`](https://github.com/bernardcooke53/python-semantic-release/commit/7cfe01d9dd35b74892d64238c4aa0d50b845b113))
...
default versioning behaviour is commiting ([`c0cd1f5`](https://github.com/bernardcooke53/python-semantic-release/commit/c0cd1f5b2e0776d7b636c3dd9e5ae863125219e6))

* feat: don&#39;t use file to track version, only tag to commit for versioning ([`cd25862`](https://github.com/bernardcooke53/python-semantic-release/commit/cd258623ee518c009ae921cd6bb3119dafae43dc))

* feat: get repo version from historical tags instead of config file

repo version will get from historical tags. init 0.0.0 if fail of find any version tag ([`a45a9bf`](https://github.com/bernardcooke53/python-semantic-release/commit/a45a9bfb64538efeb7f6f42bb6e7ede86a4ddfa8))

### Fix

* fix: can&#39;t get the proper last tag from commit history

repo.tags returns a list sorted by the name rather than date, fix it by sorting them before iteration ([`5a0e681`](https://github.com/bernardcooke53/python-semantic-release/commit/5a0e681e256ec511cd6c6a8edfee9d905891da10))
...
remove some duplicate codes ([`4f11a86`](https://github.com/bernardcooke53/python-semantic-release/commit/4f11a86b3b4b0d7a58cee83898d7568acecb5f94))

### Style

* style: flake8 check ([`20422b4`](https://github.com/bernardcooke53/python-semantic-release/commit/20422b4f1192c52c6706a4a7ddbc895e3e9208c8))

### Test

* test: correct tests for tag version ([`1230fe9`](https://github.com/bernardcooke53/python-semantic-release/commit/1230fe9add99bce2323f40e955d880fbb3f60216))

* test: change repo owner for online CI ([`2107813`](https://github.com/bernardcooke53/python-semantic-release/commit/210781354458a9a952044dfadaf0f3e839109e29))

### Unknown

* 3.9.0 ([`52bf48b`](https://github.com/bernardcooke53/python-semantic-release/commit/52bf48b93be7d8feeef5207f0dc9f7ddbd583da4))

* Merge pull request #54 from KenMercusLai/master

add option to use tag instead of creating new commit when versioning ([`8e9c021`](https://github.com/bernardcooke53/python-semantic-release/commit/8e9c021cdf6bf8ed3d7cc7dc9c42187e893f23bf))
...
* chore: Grammar fix (#61) ([`1f424c8`](https://github.com/bernardcooke53/python-semantic-release/commit/1f424c8ad48d6c1054cf3d93712d408a2e8bef3d))

### Fix

* fix: Add search_parent_directories option to gitpython (#62) ([`8bf9ce1`](https://github.com/bernardcooke53/python-semantic-release/commit/8bf9ce11137399906f18bc8b25698b6e03a65034))

### Unknown

* 3.8.1 ([`378e2eb`](https://github.com/bernardcooke53/python-semantic-release/commit/378e2eb6d228cc8b6e5c57e78cae3fe801fc974b))
...
release. ([`6f3b9d8`](https://github.com/bernardcooke53/python-semantic-release/commit/6f3b9d897bfc67137beb0b104e572ef5ac1b3756))

* chore: Pull master in after success ([`325d216`](https://github.com/bernardcooke53/python-semantic-release/commit/325d216c8a25c38e080181a37a9ada17ece7d857))

* chore: Run correct tox environments on frigg ([`0d4bdad`](https://github.com/bernardcooke53/python-semantic-release/commit/0d4bdad0348a01e8eb868fcfdeb9750cad03a20b))

* chore: Fix indentation in frigg settings ([`f9cecc5`](https://github.com/bernardcooke53/python-semantic-release/commit/f9cecc56fc034c554670aa238de4d36aeb4d3882))

* chore: Add release in after success in frigg settings ([`7bb4d7e`](https://github.com/bernardcooke53/python-semantic-release/commit/7bb4d7e1f317d0ddef28e9c8ca42452ae20d8af9))

* chore: Remove travis ([`93e5507`](https://github.com/bernardcooke53/python-semantic-release/commit/93e5507da6d53ecf63405507390633ef480c52fb))

* chore: Move coverage to tox ([`9865e9c`](https://github.com/bernardcooke53/python-semantic-release/commit/9865e9c2aaa1519beed71c301865e8e117face64))

* chore: Add tox and sphinx as dev dependencies ([`0237fcd`](https://github.com/bernardcooke53/python-semantic-release/commit/0237fcdc883be32d4e96ca3d4b32e89c8612220c))

### Documentation

* docs: Add info about trello board in readme ([`5229557`](https://github.com/bernardcooke53/python-semantic-release/commit/5229557099d76b3404ea3677292332442a57ae2e))

* docs: Update info about releases in contributing.md ([`466f046`](https://github.com/bernardcooke53/python-semantic-release/commit/466f0460774cad86e7e828ffb50c7d1332b64e7b))

* docs: Add info about correct commit guidelines ([`af35413`](https://github.com/bernardcooke53/python-semantic-release/commit/af35413fae80889e2c5fc6b7d28f77f34b3b4c02))

* docs: Fix badges in readme ([`7f4e549`](https://github.com/bernardcooke53/python-semantic-release/commit/7f4e5493edb6b3fb3510d0bb78fcc8d23434837f))

### Feature

* feat: Add ci checks for circle ci ([`151d849`](https://github.com/bernardcooke53/python-semantic-release/commit/151d84964266c8dca206cef8912391cb73c8f206))

### Fix

* fix: Refactoring cli.py to improve --help and error messages ([`c79fc34`](https://github.com/bernardcooke53/python-semantic-release/commit/c79fc3469fb99bf4c7f52434fa9c0891bca757f9))

* fix: Add git fetch to frigg after success ([`74a6cae`](https://github.com/bernardcooke53/python-semantic-release/commit/74a6cae2b46c5150e63136fde0599d98b9486e36))
...
while because the tests was not ran by pytest. ([`9496f6a`](https://github.com/bernardcooke53/python-semantic-release/commit/9496f6a502c79ec3acb4e222e190e76264db02cf))

### Test

* test: Add tests for circle ci checks ([`fa1223c`](https://github.com/bernardcooke53/python-semantic-release/commit/fa1223c661d60033b7d7aba2a27151d6ee18a299))

* test: Mock to fix cli tests ([`24e5f7a`](https://github.com/bernardcooke53/python-semantic-release/commit/24e5f7a85bea75101b60baeeb36d6915464830c1))

* test: Make sure all publish tests mocks checkout

If not the tests will checkout master ([`742b2e9`](https://github.com/bernardcooke53/python-semantic-release/commit/742b2e9e082c15f22052d64dea66f2d997d3d69b))

* test: Restructure ci checks tests ([`f36eb2e`](https://github.com/bernardcooke53/python-semantic-release/commit/f36eb2ede0d6c4cb09861e5497629929c0ce4749))

### Unknown

* 3.8.0 ([`8779773`](https://github.com/bernardcooke53/python-semantic-release/commit/8779773444f54a8090b9d341b644f68a70ddb785))

* Merge pull request #57 from relekang/feat/add-circle-ci-checks

Add circle ci checks ([`7af9816`](https://github.com/bernardcooke53/python-semantic-release/commit/7af9816610669a9c697bfe198e98da33e5ed0a29))

* Merge pull request #58 from relekang/refactor-cli-py

fix: Refactoring cli.py to improve --help and error messages ([`a0bf0ff`](https://github.com/bernardcooke53/python-semantic-release/commit/a0bf0ff0eb0cd0140f851b9f7b7e18c2710dbad5))

* Merge pull request #60 from relekang/test/fix-cli-tests

test: Mock to fix cli tests ([`d6df71d`](https://github.com/bernardcooke53/python-semantic-release/commit/d6df71d6fb990c84bf5e01d45d5b0cab399da4d8))

* Merge pull request #59 from relekang/test/fix-structure

fix: Make tag parser work correctly with breaking changes ([`1e9a581`](https://github.com/bernardcooke53/python-semantic-release/commit/1e9a581e89757fb603a340bbc519e07b59b143e9))

* Merge pull request #56 from relekang/dev-deps

chore: Add tox and sphinx as dev dependencies ([`3beb444`](https://github.com/bernardcooke53/python-semantic-release/commit/3beb444ba34da785a2c3bcf2359e561c9be7abdd))
...
* fix: move code around a bit to make flake8 happy ([`41463b4`](https://github.com/bernardcooke53/python-semantic-release/commit/41463b49b5d44fd94c11ab6e0a81e199510fabec))

### Unknown

* 3.7.2 ([`dde8bbf`](https://github.com/bernardcooke53/python-semantic-release/commit/dde8bbfd71d048d05a92d87bae0c6e45056b52e2))

* Merge pull request #55 from relekang/flake8-fixes

fix: move code around a bit to make flake8 happy ([`2184549`](https://github.com/bernardcooke53/python-semantic-release/commit/218454986be540b90e7d3af45a76c02d3c5f6ee2))
...
* docs(configuration): Fix typo in setup.cfg section ([`725d87d`](https://github.com/bernardcooke53/python-semantic-release/commit/725d87dc45857ef2f9fb331222845ac83a3af135))

### Unknown

* 3.7.1 ([`0aaa112`](https://github.com/bernardcooke53/python-semantic-release/commit/0aaa112880559e968f8c0053cfb84cf7eaed64cf))

* Merge pull request #50 from edwelker/doc_fix

documentation typo ([`b3c52c2`](https://github.com/bernardcooke53/python-semantic-release/commit/b3c52c27293f8944ea34a6a42b348082e80275fe))

* documentation typo ([`b77d484`](https://github.com/bernardcooke53/python-semantic-release/commit/b77d484e119daa0c2fe86bc558eda972d4852a83))
...
* feat: Add ci_checks for Frigg CI ([`577c374`](https://github.com/bernardcooke53/python-semantic-release/commit/577c374396fe303b6fe7d64630d2959998d3595c))

### Unknown

* 3.7.0 ([`10825b5`](https://github.com/bernardcooke53/python-semantic-release/commit/10825b5fe633f7cc2ea618ac3402be36fc10e8ee))
...
* fix: Add requests as dependency ([`4525a70`](https://github.com/bernardcooke53/python-semantic-release/commit/4525a70d5520b44720d385b0307e46fae77a7463))

### Unknown

* 3.6.1 ([`8f5dd02`](https://github.com/bernardcooke53/python-semantic-release/commit/8f5dd025577c8d66c2d762070bfebbe31c77ab00))
...
* docs: Add step by step guide for configuring travis ci ([`6f23414`](https://github.com/bernardcooke53/python-semantic-release/commit/6f2341442f61f0284b1119a2c49e96f0be678929))

* docs: Remove duplicate readme

It was created by pandoc earlier when the original readme was written in
markdown. ([`42a9421`](https://github.com/bernardcooke53/python-semantic-release/commit/42a942131947cd1864c1ba29b184caf072408742))

* docs: Add note about node semantic release ([`0d2866c`](https://github.com/bernardcooke53/python-semantic-release/commit/0d2866c528098ecaf1dd81492f28d3022a2a54e0))

* docs: Move automatic-releases to subfolder ([`ed68e5b`](https://github.com/bernardcooke53/python-semantic-release/commit/ed68e5b8d3489463e244b078ecce8eab2cba2bb1))

* docs: Add documentation for configuring on CI ([`7806940`](https://github.com/bernardcooke53/python-semantic-release/commit/7806940ae36cb0d6ac0f966e5d6d911bd09a7d11))

### Feature

* feat: Add checks for semaphore

Fixes #44 ([`2d7ef15`](https://github.com/bernardcooke53/python-semantic-release/commit/2d7ef157b1250459060e99601ec53a00942b6955))

### Unknown

* 3.6.0 ([`4916f16`](https://github.com/bernardcooke53/python-semantic-release/commit/4916f16c0a6602fafd52222f3c930ceebade686a))
...
* chore: Re-add git user config to travis config ([`2c2809e`](https://github.com/bernardcooke53/python-semantic-release/commit/2c2809ea360977c1e4010c84ac2d43ef94dc6154))

* chore: Remove unecessary git commands from travis after_success ([`a863b62`](https://github.com/bernardcooke53/python-semantic-release/commit/a863b620012b4528f1a5edcea3f8a428a2c690d5))

### Documentation

* docs: Convert readme to rst ([`e8a8d26`](https://github.com/bernardcooke53/python-semantic-release/commit/e8a8d265aa2147824f18065b39a8e7821acb90ec))

### Feature

* feat: Checkout master before publishing

Related to #39 ([`dc4077a`](https://github.com/bernardcooke53/python-semantic-release/commit/dc4077a2d07e0522b625336dcf83ee4e0e1640aa))

* feat: Add author in commit

Fixes #40 ([`020efaa`](https://github.com/bernardcooke53/python-semantic-release/commit/020efaaadf588e3fccd9d2f08a273c37e4158421))

### Fix

* fix: Remove &#34; from git push command ([`031318b`](https://github.com/bernardcooke53/python-semantic-release/commit/031318b3268bc37e6847ec049b37425650cebec8))

### Refactor

* refactor: Use gitpython instead of invoke in vcs_helpers

Fixes #3 ([`0d9b9a7`](https://github.com/bernardcooke53/python-semantic-release/commit/0d9b9a76f8292889dc7fbb802988073ffbe59a4e))

### Unknown

* 3.5.0 ([`fb67b5f`](https://github.com/bernardcooke53/python-semantic-release/commit/fb67b5ffb2df7d11b1daf6d7eef46f843f5cfd62))
...
* chore: Convert cli tests to pytest ([`40da8bb`](https://github.com/bernardcooke53/python-semantic-release/commit/40da8bb2bd96c06c044da2abc77d8f57f9a11347))

* chore: Add checkout master to travis after_success ([`b79310a`](https://github.com/bernardcooke53/python-semantic-release/commit/b79310aa2f532680b33d30271aeb04dfd906019a))
...
and not in a pull-request. ([`f386db7`](https://github.com/bernardcooke53/python-semantic-release/commit/f386db75b77acd521d2f5bde2e1dde99924dc096))

### Unknown

* 3.4.0 ([`397ba66`](https://github.com/bernardcooke53/python-semantic-release/commit/397ba668f4bbb1f6a0385390ce1f4e4efbf98dbf))
...
* fix: Do git push and git push --tags instead of --follow-tags ([`8bc70a1`](https://github.com/bernardcooke53/python-semantic-release/commit/8bc70a183fd72f595c72702382bc0b7c3abe99c8))

### Unknown

* 3.3.3 ([`d1664bb`](https://github.com/bernardcooke53/python-semantic-release/commit/d1664bbaa83ea60c15c5652f7dfe2084e458d48d))

* 3.3.2 ([`68510b6`](https://github.com/bernardcooke53/python-semantic-release/commit/68510b6f27923d407087db07c56deb2f2f404fe4))
...
* docs: Update docstrings for generate_changelog ([`987c6a9`](https://github.com/bernardcooke53/python-semantic-release/commit/987c6a96d15997e38c93a9d841c618c76a385ce7))

### Fix

* fix: Change build badge ([`0dc068f`](https://github.com/bernardcooke53/python-semantic-release/commit/0dc068fff2f8c6914f4abe6c4e5fb2752669159e))
...
* chore: Use python 2 travis env ([`22c8d67`](https://github.com/bernardcooke53/python-semantic-release/commit/22c8d678358ea8d1808a9c058861d4055d13e0fd))

* chore: Fix version number ([`7041a4c`](https://github.com/bernardcooke53/python-semantic-release/commit/7041a4c40b7dec5ea201a051e2e4ec572f93e358))

### Fix

* fix: Only list commits from the last version tag

Fixes #28 ([`191369e`](https://github.com/bernardcooke53/python-semantic-release/commit/191369ebd68526e5b1afcf563f7d13e18c8ca8bf))

* fix: Add pandoc to travis settings ([`17d40a7`](https://github.com/bernardcooke53/python-semantic-release/commit/17d40a73062ffa774542d0abc0f59fc16b68be37))

### Refactor

* refactor: Fix quantified code warnings ([`6d16953`](https://github.com/bernardcooke53/python-semantic-release/commit/6d1695320e09320f43efca403992d7d1791ff2a7))

### Unknown

* 3.3.1 ([`0334b81`](https://github.com/bernardcooke53/python-semantic-release/commit/0334b81c247be5bf222975d894f5ced9d38fb812))

* Merge remote-tracking branch &#39;origin/depsy/click-equals-6.2&#39; ([`f0f7937`](https://github.com/bernardcooke53/python-semantic-release/commit/f0f7937cca61c53b25e1e39b78356345e73b2033))
...
* chore: Fix pep8 warnings ([`07977b5`](https://github.com/bernardcooke53/python-semantic-release/commit/07977b5db86cd0a36172f11dbd035bde9348618b))

* chore: Use semantic-release for publishing ([`e5b6119`](https://github.com/bernardcooke53/python-semantic-release/commit/e5b6119b76007345a8fe8e60d18c4c0587b437b7))

### Feature

* feat: Add support for environment variables for pypi credentials ([`3b383b9`](https://github.com/bernardcooke53/python-semantic-release/commit/3b383b92376a7530e89b11de481c4dfdfa273f7b))

### Fix

* fix: Downgrade twine to version 1.5.0 ([`66df378`](https://github.com/bernardcooke53/python-semantic-release/commit/66df378330448a313aff7a7c27067adda018904f))

* fix: Add missing parameters to twine.upload ([`4bae22b`](https://github.com/bernardcooke53/python-semantic-release/commit/4bae22bae9b9d9abf669b028ea3af4b3813a1df0))

* fix: Push to master by default ([`a0bb023`](https://github.com/bernardcooke53/python-semantic-release/commit/a0bb023438a1503f9fdb690d976d71632f19a21f))

* fix: Better filtering of github token in push error ([`9b31da4`](https://github.com/bernardcooke53/python-semantic-release/commit/9b31da4dc27edfb01f685e6036ddbd4c715c9f60))

* fix: Make sure the github token is not in the output ([`55356b7`](https://github.com/bernardcooke53/python-semantic-release/commit/55356b718f74d94dd92e6c2db8a15423a6824eb5))

### Unknown

* Upgrade dependency click to ==6.2 ([`1c5f3cd`](https://github.com/bernardcooke53/python-semantic-release/commit/1c5f3cde6a8a892b1fe48eae39424d3d483b5935))
...
* chore: Update travis pypi password ([`7437c80`](https://github.com/bernardcooke53/python-semantic-release/commit/7437c809f8599714e143155b66858a47857b98d7))

### Fix

* fix: Add requirements to manifest ([`ed25ecb`](https://github.com/bernardcooke53/python-semantic-release/commit/ed25ecbaeec0e20ad3040452a5547bb7d6faf6ad))
...
clients will then download the latest sdist package available. ([`a1a35f4`](https://github.com/bernardcooke53/python-semantic-release/commit/a1a35f43175187091f028474db2ebef5bfc77bc0))

### Unknown

* 3.2.1 ([`ab83167`](https://github.com/bernardcooke53/python-semantic-release/commit/ab83167d630bde385622178147037856641e2118))
...
* chore: Fix command in travis file ([`edb12d1`](https://github.com/bernardcooke53/python-semantic-release/commit/edb12d1d7d1c6c0539f28b6d5e9581ea8af105cb))

* chore: Add git config to travis setup ([`7cc1510`](https://github.com/bernardcooke53/python-semantic-release/commit/7cc15107ceca1aa1ef25d5ae06e6119c6d9ee4c3))

* chore: Make travis have one environment ([`ec2a003`](https://github.com/bernardcooke53/python-semantic-release/commit/ec2a003230040303e768db1c03e87770bc701e52))

* chore: Setup travis ([`f283875`](https://github.com/bernardcooke53/python-semantic-release/commit/f2838755163dad9ab5766e6bbf494daf37667cec))

### Feature

* feat(git): Add push to GH_TOKEN@github-url ([`546b5bf`](https://github.com/bernardcooke53/python-semantic-release/commit/546b5bf15466c6f5dfe93c1c03ca34604b0326f2))

* feat(angular-parser): Remove scope requirement ([`90c9d8d`](https://github.com/bernardcooke53/python-semantic-release/commit/90c9d8d4cd6d43be094cda86579e00b507571f98))

### Fix

* fix(deps): Use one file for requirements ([`4868543`](https://github.com/bernardcooke53/python-semantic-release/commit/486854393b24803bb2356324e045ccab17510d46))

### Test

* test: Update test setup ([`ac1e686`](https://github.com/bernardcooke53/python-semantic-release/commit/ac1e6862d8990bb35250478d38af170ccedc81eb))

### Unknown

* 3.2.0 ([`bf85122`](https://github.com/bernardcooke53/python-semantic-release/commit/bf85122335173076fa6c018a506a546fa16b0aa6))

* Merge pull request #29 from relekang/depsy-decisive-upgrade-15_10_17_07_51_03

[Depsy] Upgrade dependencies ([`4987a31`](https://github.com/bernardcooke53/python-semantic-release/commit/4987a31ae78e8fc202497a01591ba0881e82437e))

* Add links to the node project ([`3567952`](https://github.com/bernardcooke53/python-semantic-release/commit/3567952d8e84235c58aa7e310689de8d4b07f7ad))

* Upgrade dependency twine to ==1.6.3 ([`f96e9b2`](https://github.com/bernardcooke53/python-semantic-release/commit/f96e9b2e066465e657b3d25708713f5d20b6942f))

* Upgrade dependency semver to ==2.2.1 ([`63b4b99`](https://github.com/bernardcooke53/python-semantic-release/commit/63b4b9949816cef110a2ce3c10707525623bd8ef))

* Upgrade dependency invoke to ==0.11.1 ([`b9fe5eb`](https://github.com/bernardcooke53/python-semantic-release/commit/b9fe5eb8bf1f44df53ffe7924c999142d65b5520))

* Upgrade dependency click to ==5.1 ([`662bc2d`](https://github.com/bernardcooke53/python-semantic-release/commit/662bc2dea8f4f9792bd63d8a6490181547aa1499))

* Upgrade dependency twine to ==1.6.3 ([`571dd43`](https://github.com/bernardcooke53/python-semantic-release/commit/571dd43f10498882b2828afb334c9e82f839e040))

* Upgrade dependency semver to ==2.2.1 ([`e656bea`](https://github.com/bernardcooke53/python-semantic-release/commit/e656bea8c0004e6952f8868569a7460a13ae3e40))

* Upgrade dependency invoke to ==0.11.1 ([`31a2051`](https://github.com/bernardcooke53/python-semantic-release/commit/31a205143492a13bc796cf9755ae78231ae35c00))

* Upgrade dependency click to ==5.1 ([`d0b6c7d`](https://github.com/bernardcooke53/python-semantic-release/commit/d0b6c7d968961d7bc84560ca22f3b9a8634e08a9))

* Upgrade dependency responses to ==0.5.0 ([`fcf9e1a`](https://github.com/bernardcooke53/python-semantic-release/commit/fcf9e1a806236fc09a472ba6e58cf44f57b2147f))
...
* chore(imports): Make all imports relative ([`d6ce17b`](https://github.com/bernardcooke53/python-semantic-release/commit/d6ce17b85a6d18a526a9a68e7ec51e7f635ca15b))

### Feature

* feat(pypi): Add option to disable pypi upload ([`f5cd079`](https://github.com/bernardcooke53/python-semantic-release/commit/f5cd079edb219de5ad03a71448d578f5f477da9c))

### Unknown

* 3.1.0 ([`93cb147`](https://github.com/bernardcooke53/python-semantic-release/commit/93cb147ca0d360cd5c51b642f8d7ce2abb576698))
...
* chore(pytest): Use assert in pytest-test ([`d8d1f9d`](https://github.com/bernardcooke53/python-semantic-release/commit/d8d1f9d5ace0db71cf256e809ebf44ff090d9237))

* chore(setup.py): Remove uneded variable ([`e54774c`](https://github.com/bernardcooke53/python-semantic-release/commit/e54774c897245b4da2f1e407d9ac848e6f712ef9))
...
&lt;explanation&gt; for a breaking change ([`a7f392f`](https://github.com/bernardcooke53/python-semantic-release/commit/a7f392fd4524cc9207899075631032e438e2593c))

### Fix

* fix(errors): Add exposing of errors in package ([`3662d76`](https://github.com/bernardcooke53/python-semantic-release/commit/3662d7663291859dd58a91b4b4ccde4f0edc99b2))

* fix(version): Parse file instead for version

This makes it possible to use the version command without a setup.py
file. ([`005dba0`](https://github.com/bernardcooke53/python-semantic-release/commit/005dba0094eeb4098315ef383a746e139ffb504d))

### Unknown

* 3.0.0 ([`592fedb`](https://github.com/bernardcooke53/python-semantic-release/commit/592fedb52633de40e0b07b418acc6c9d796179a4))

* Merge branch &#39;tag-parser&#39; ([`2519b42`](https://github.com/bernardcooke53/python-semantic-release/commit/2519b42c7381fe8217b34150bd1ad06b23c9a56d))
...
Properties can only be used from instances. ([`7ecdeb2`](https://github.com/bernardcooke53/python-semantic-release/commit/7ecdeb22de96b6b55c5404ebf54a751911c4d8cd))

### Refactor

* refactor(parsers): Move the parsing of the parts after line one to helpers ([`cefc8c6`](https://github.com/bernardcooke53/python-semantic-release/commit/cefc8c68ed1d454010a5d81e752ec7b0b1761ebb))

### Unknown

* 2.1.4 ([`a05210f`](https://github.com/bernardcooke53/python-semantic-release/commit/a05210f4274f10ddd5385241c99b6d77996c9544))
...
* chore(qc): Fix warnings from quantifiedcode ([`73c5da2`](https://github.com/bernardcooke53/python-semantic-release/commit/73c5da25810e89c66777664a64c0a34b7ddbffb0))

* chore(test): Use mock package instead of unittest.mock ([`5376a56`](https://github.com/bernardcooke53/python-semantic-release/commit/5376a5602889fdae542eb7b13ae529ee001ad0aa))

### Documentation

* docs(readme): Update readme with information about the changelog command ([`56a745e`](https://github.com/bernardcooke53/python-semantic-release/commit/56a745ef6fa4edf6f6ba09c78fcc141102cf2871))

* docs(parsers): Add documentation about commit parsers ([`9b55422`](https://github.com/bernardcooke53/python-semantic-release/commit/9b554222768036024a133153a559cdfc017c1d91))

* docs(api): Update apidocs ([`6185380`](https://github.com/bernardcooke53/python-semantic-release/commit/6185380babedbbeab2a2a342f17b4ff3d4df6768))

### Fix

* fix(hvcs): Make Github.token an property ([`37d5e31`](https://github.com/bernardcooke53/python-semantic-release/commit/37d5e3110397596a036def5f1dccf0860964332c))

### Unknown

* 2.1.3 ([`4979071`](https://github.com/bernardcooke53/python-semantic-release/commit/4979071d9330f2f3648358000de3a642a385a828))
...
* fix(cli): Fix call to generate_changelog in publish ([`5f8bce4`](https://github.com/bernardcooke53/python-semantic-release/commit/5f8bce4cbb5e1729e674efd6c651e2531aea2a16))

### Unknown

* 2.1.2 ([`dfb37cb`](https://github.com/bernardcooke53/python-semantic-release/commit/dfb37cbde0a877ca482095711cbb08f52ab3cf45))
...
* fix(history): Fix issue in get_previous_version ([`f961786`](https://github.com/bernardcooke53/python-semantic-release/commit/f961786aa3eaa3a620f47cc09243340fd329b9c2))

### Unknown

* 2.1.1 ([`7cf3a7d`](https://github.com/bernardcooke53/python-semantic-release/commit/7cf3a7d9aa2adc5a3cebf9d1151b113388117312))
...
* chore(pep8): Fix pep8 warning ([`5108b17`](https://github.com/bernardcooke53/python-semantic-release/commit/5108b177ed2b50b50e3476997f9d1f73adaa3f95))

### Feature

* feat(cli): Add the possibility to repost the changelog ([`4d028e2`](https://github.com/bernardcooke53/python-semantic-release/commit/4d028e21b9da01be8caac8f23f2c11e0c087e485))

### Fix

* fix(cli): Fix check of token in changelog command ([`cc6e6ab`](https://github.com/bernardcooke53/python-semantic-release/commit/cc6e6abe1e91d3aa24e8d73e704829669bea5fd7))

* fix(github): Fix the github releases integration ([`f0c3c1d`](https://github.com/bernardcooke53/python-semantic-release/commit/f0c3c1db97752b71f2153ae9f623501b0b8e2c98))

* fix(history): Fix changelog generation

This enables regeneration of a given versions changelog. ([`f010272`](https://github.com/bernardcooke53/python-semantic-release/commit/f01027203a8ca69d21b4aff689e60e8c8d6f9af5))

### Test

* test(github): Fix broken tests ([`a140ecd`](https://github.com/bernardcooke53/python-semantic-release/commit/a140ecdc81c8e639b8d9adbedc7ac850c17f09cc))

### Unknown

* 2.1.0 ([`4b78940`](https://github.com/bernardcooke53/python-semantic-release/commit/4b789409936a5997d6c2f277083930b6e4b3b643))
...
use the angular commit message spec to determine the new version. ([`c2cf537`](https://github.com/bernardcooke53/python-semantic-release/commit/c2cf537a42beaa60cd372c7c9f8fb45db8085917))

### Feature

* feat(publish): Add publishing of changelog to github ([`74324ba`](https://github.com/bernardcooke53/python-semantic-release/commit/74324ba2749cdbbe80a92b5abbecfeab04617699))

* feat(github): Add github release changelog helper ([`da18795`](https://github.com/bernardcooke53/python-semantic-release/commit/da187951af31f377ac57fe17462551cfd776dc6e))

* feat(history): Add markdown changelog formatter ([`d77b58d`](https://github.com/bernardcooke53/python-semantic-release/commit/d77b58db4b66aec94200dccab94f483def4dacc9))

* feat(cli): Add command for printing the changelog

Usage: `semantic_release changelog` ([`336b8bc`](https://github.com/bernardcooke53/python-semantic-release/commit/336b8bcc01fc1029ff37a79c92935d4b8ea69203))

* feat(history): Add generate_changelog function

It generates a dict with changelog information to each of the given
section types. ([`347f21a`](https://github.com/bernardcooke53/python-semantic-release/commit/347f21a1f8d655a71a0e7d58b64d4c6bc6d0bf31))

* feat(settings): Add loading of current parser ([`7bd0916`](https://github.com/bernardcooke53/python-semantic-release/commit/7bd0916f87a1f9fe839c853eab05cae1af420cd2))
...
Related to #17 ([`91e4f0f`](https://github.com/bernardcooke53/python-semantic-release/commit/91e4f0f4269d01b255efcd6d7121bbfd5a682e12))

### Fix

* fix(cli): Change output indentation on changelog ([`2ca41d3`](https://github.com/bernardcooke53/python-semantic-release/commit/2ca41d3bd1b8b9d9fe7e162772560e3defe2a41e))

* fix(history): Support unexpected types in changelog generator ([`13deacf`](https://github.com/bernardcooke53/python-semantic-release/commit/13deacf5d33ed500e4e94ea702a2a16be2aa7c48))

* fix(history): Fix regex in angular parser

This fixes a problem where multiline commit messages where not correctly
parsed. ([`974ccda`](https://github.com/bernardcooke53/python-semantic-release/commit/974ccdad392d768af5e187dabc184be9ac3e133d))

* fix(history): Fix level id&#39;s in angular parser ([`2918d75`](https://github.com/bernardcooke53/python-semantic-release/commit/2918d759bf462082280ede971a5222fe01634ed8))

### Refactor

* refactor(test): Move exit code assertion in cli tests ([`345c299`](https://github.com/bernardcooke53/python-semantic-release/commit/345c299cbf4c0e626eb482b2f577dc8c5fd9426a))

* refactor(history): Move evaluate_version_bump ([`c448d9b`](https://github.com/bernardcooke53/python-semantic-release/commit/c448d9b056d48d607a8bf7d38b8cf8a8ba038ca6))

### Style

* style(pep8): Fix pep8 and isort warnings ([`87695b1`](https://github.com/bernardcooke53/python-semantic-release/commit/87695b1684ad55e26e1489ab9d835cf8a9854654))

### Unknown

* 2.0.0 ([`6493a58`](https://github.com/bernardcooke53/python-semantic-release/commit/6493a58727ecd082e3ae12619fef6c3c982cc6e2))

* Add badges in readme ([`ad7c9c6`](https://github.com/bernardcooke53/python-semantic-release/commit/ad7c9c69329efe8af42112f716c39e810ed22718))

* Add cumulative coverage ([`15c5ea0`](https://github.com/bernardcooke53/python-semantic-release/commit/15c5ea0106ed08ef8d896d100cf1987c0b5fc17a))

* Update api-docs ([`4654655`](https://github.com/bernardcooke53/python-semantic-release/commit/4654655c33afc7cead9c238a14e4b71cc7121aa5))

* Fix #19, add config documentation ([`354b2ca`](https://github.com/bernardcooke53/python-semantic-release/commit/354b2cabfc7e4a8d2c95ebd2801cc4dbca67fa5a))
...
* 1.0.0 ([`a91662c`](https://github.com/bernardcooke53/python-semantic-release/commit/a91662c55d01af096cc45bf8844bcc6d87c1bcee))

* :boom: Restructure helpers into history and pypi ([`00f64e6`](https://github.com/bernardcooke53/python-semantic-release/commit/00f64e623db0e21470d55488c5081e12d6c11fd3))

* Rename git_helpers to vcs_helpers ([`77d701b`](https://github.com/bernardcooke53/python-semantic-release/commit/77d701b89c93a761c83965f7c267c7ec35989ec2))

* Make authors file a list ([`31b0f3a`](https://github.com/bernardcooke53/python-semantic-release/commit/31b0f3a3c6a0c5e9d4d9521aba0a303adefdeeec))

* Fix #18, add docs for automatic publishing ([`58076e6`](https://github.com/bernardcooke53/python-semantic-release/commit/58076e60bf20a5835b112b5e99a86c7425ffe7d9))

* Set alabaster as sphinx theme ([`1f698fe`](https://github.com/bernardcooke53/python-semantic-release/commit/1f698fe249a3cc646006b6f922e6b7ec8e12563f))

* Add @jezdez to AUTHORS.rst ([`985df2d`](https://github.com/bernardcooke53/python-semantic-release/commit/985df2dd052668f72e99274370e335e47d5c5d39))

* Add pytest-xdist as requirements ([`35961d7`](https://github.com/bernardcooke53/python-semantic-release/commit/35961d7cc17a862710661b9f9e25aa276d2f505b))

* Fix current head hash test ([`ed9a879`](https://github.com/bernardcooke53/python-semantic-release/commit/ed9a8795d2e72cbdd6689eec4fea2622a5654bc6))
...
* 0.9.1 ([`240971f`](https://github.com/bernardcooke53/python-semantic-release/commit/240971f4de808be27a5d8c54bd40156d80d38913))

* :bug: Fix get_current_head_hash, ensure it only returns the hash ([`7c28832`](https://github.com/bernardcooke53/python-semantic-release/commit/7c2883209e5bf4a568de60dbdbfc3741d34f38b4))
...
* 0.9.0 ([`85bfaae`](https://github.com/bernardcooke53/python-semantic-release/commit/85bfaaec2236e6c144bfb31ea12240ed6150c28b))

* Merge pull request #15 from jezdez/python-2

Add Python 2.7 support. Fix #10.
:sparkles: ([`5daabb7`](https://github.com/bernardcooke53/python-semantic-release/commit/5daabb75eb9145566a2a7c2a9e64439df7cd85f1))

* Add Python 2.7 support. Fix #10. ([`c05e13f`](https://github.com/bernardcooke53/python-semantic-release/commit/c05e13f22163237e963c493ffeda7e140f0202c6))

* Merge pull request #14 from jezdez/assertion-fix

Fixed name of assertion function. ([`aeb62df`](https://github.com/bernardcooke53/python-semantic-release/commit/aeb62dfcb6aa123f47f612dc209415c7fb4fe889))

* Fixed cli tests to use correct params for call assertion. ([`456b26b`](https://github.com/bernardcooke53/python-semantic-release/commit/456b26be7130e51a7a46310f65dffb615b30a097))

* Fixed name of assertion function. ([`9b16098`](https://github.com/bernardcooke53/python-semantic-release/commit/9b1609813ae71d5605b8ec9754d737ba38465537))
...
* 0.8.0 ([`6ec8a3e`](https://github.com/bernardcooke53/python-semantic-release/commit/6ec8a3e22f0914dd0d995c809f5b5d078825bc9a))

* Fix version test, add missing mock ([`71842d4`](https://github.com/bernardcooke53/python-semantic-release/commit/71842d4d50fa16fbdba0487d1c8f6d0eb6b7d407))

* Set check_build_status in semantic-release config ([`00f1a4e`](https://github.com/bernardcooke53/python-semantic-release/commit/00f1a4ef5283733d580c6bb02ed25d511a8b0c0b))

* :bug: Fix test_defaults in settings test ([`b269d27`](https://github.com/bernardcooke53/python-semantic-release/commit/b269d27ca1c1cfc9efd25abab2de619b6f3ef9d6))

* Add release schedule note ([`8bc8fba`](https://github.com/bernardcooke53/python-semantic-release/commit/8bc8fba7dc3bd6bcea0cc5e5946e85f6f8e1c6d7))

* Add output when running check_build_status ([`8bdda5a`](https://github.com/bernardcooke53/python-semantic-release/commit/8bdda5aba626fcbed8d357551f6d77fca5d1839d))

* Add default value in check_build_status docs ([`eb0c46d`](https://github.com/bernardcooke53/python-semantic-release/commit/eb0c46d00e0f07e1e902b33470dbf7309146964f))

* :sparkles: Fix #5, Add check_build_status option ([`310bb93`](https://github.com/bernardcooke53/python-semantic-release/commit/310bb9371673fcf9b7b7be48422b89ab99753f04))

* :sparkles: Add get_current_head_hash in git helpers ([`d864282`](https://github.com/bernardcooke53/python-semantic-release/commit/d864282c498f0025224407b3eeac69522c2a7ca0))

* :sparkles: Add git helper to get owner and name of repo ([`f940b43`](https://github.com/bernardcooke53/python-semantic-release/commit/f940b435537a3c93ab06170d4a57287546bd8d3b))
...
* 0.7.0 ([`aeb11f7`](https://github.com/bernardcooke53/python-semantic-release/commit/aeb11f74a93fe7e64e9507f9a62202b833ee5733))

* :sparkles: Add patch_without_tag option, fixes #6 ([`3734a88`](https://github.com/bernardcooke53/python-semantic-release/commit/3734a889f753f1b9023876e100031be6475a90d1))

* Move defaults to cfg file ([`cb1257a`](https://github.com/bernardcooke53/python-semantic-release/commit/cb1257a60a81cb5aadbc8f6470ec2ec2c904506c))

* Add contributing.rst ([`a27e282`](https://github.com/bernardcooke53/python-semantic-release/commit/a27e28223b8186bda66cc882454746a5595d8643))

* Fix docstring in setup_hook() ([`1e47f1c`](https://github.com/bernardcooke53/python-semantic-release/commit/1e47f1c6c68b5a74515f2f86275e3c749c999e1c))

* Fix #1, Add basic setup of sphinx based docs ([`41fba78`](https://github.com/bernardcooke53/python-semantic-release/commit/41fba78a389a8d841316946757a23a7570763c39))

* Add docstrings to all functions ([`6555d5a`](https://github.com/bernardcooke53/python-semantic-release/commit/6555d5a5944fa4b7823f70fd720e193915186307))
...
* 0.6.0 ([`3acd8db`](https://github.com/bernardcooke53/python-semantic-release/commit/3acd8dbdd25f3973a536924985a37726d8665cdd))

* :sparkles: Fix #13, Add twine for uploads to pypi ([`eec2561`](https://github.com/bernardcooke53/python-semantic-release/commit/eec256115b28b0a18136a26d74cfc3232502f1a6))

* Add tests for the setup.py hook ([`ecd9e9a`](https://github.com/bernardcooke53/python-semantic-release/commit/ecd9e9a3f97bdf9489b6dc750d736855a2c109c2))

* Add test for git helpers ([`8354cfd`](https://github.com/bernardcooke53/python-semantic-release/commit/8354cfd953bb09723abcff7fefe620fc4aa6b855))

* Fix typo ([`9585217`](https://github.com/bernardcooke53/python-semantic-release/commit/9585217d95a4bb2447ae8860971575bd4c847070))

* Add link to blogpost in readme ([`1966e52`](https://github.com/bernardcooke53/python-semantic-release/commit/1966e52ab4f08d3cbabe88881c0e51e600e44567))
...
* 0.5.4 ([`b66939b`](https://github.com/bernardcooke53/python-semantic-release/commit/b66939bff790c21bd1093e9b8ae6a5dff5f38235))

* Add tests for upload_to_pypi ([`778923f`](https://github.com/bernardcooke53/python-semantic-release/commit/778923fab86d423b6ed254c569fddee1b9650f56))

* :bug: Add python2 not supported warning

Related: #9, #10 ([`e84c4d8`](https://github.com/bernardcooke53/python-semantic-release/commit/e84c4d8b6f212aec174baccd188185627b5039b6))

* Add note about python 3 only

related to #9 ([`a71b536`](https://github.com/bernardcooke53/python-semantic-release/commit/a71b53609db75316e3c14df0ece7f474393641bc))
...
* 0.5.3 ([`bed6e58`](https://github.com/bernardcooke53/python-semantic-release/commit/bed6e583161fd7651c69660ef9c6ab3252907cb9))

* Add wheel as a dependency ([`971e479`](https://github.com/bernardcooke53/python-semantic-release/commit/971e4795a8b8fea371fcc02dc9221f58a0559f32))
...
* 0.5.2 ([`f66a1f9`](https://github.com/bernardcooke53/python-semantic-release/commit/f66a1f92072d9927c35ac4ac54153bd9b5a8b3a0))

* :bug: Fix python wheel tag ([`f9ac163`](https://github.com/bernardcooke53/python-semantic-release/commit/f9ac163491666022c809ad49846f3c61966e10c1))
...
* 0.5.1 ([`6a2311a`](https://github.com/bernardcooke53/python-semantic-release/commit/6a2311adb7c4745908c0fa0ea4e5759b0e46d2b6))

* :bug: Fix push commands ([`8374ef6`](https://github.com/bernardcooke53/python-semantic-release/commit/8374ef6bd78eb564a6d846b882c99a67e116394e))
...
* 0.5.0 ([`e888160`](https://github.com/bernardcooke53/python-semantic-release/commit/e8881604c94808d0e86387cc18ee81885870e1e7))

* :sparkles: Add setup.py hook for the cli interface ([`c363bc5`](https://github.com/bernardcooke53/python-semantic-release/commit/c363bc5d3cb9e9a113de3cd0c49dd54a5ea9cf35))
...
* 0.4.0 ([`bfb1434`](https://github.com/bernardcooke53/python-semantic-release/commit/bfb1434f1861fe99dd28b653467034db1e271dfb))

* :sparkles: Add publish command ([`d8116c9`](https://github.com/bernardcooke53/python-semantic-release/commit/d8116c9dec472d0007973939363388d598697784))
...
* 0.3.2 ([`1d3ee00`](https://github.com/bernardcooke53/python-semantic-release/commit/1d3ee00c3601f06f900bc1694f3c7c32106a6e14))
...
* 0.3.1 ([`fec284c`](https://github.com/bernardcooke53/python-semantic-release/commit/fec284cdec7516b7b8067d5de2738e62434d3f31))

* :bug: Fix wheel settings ([`1e860e8`](https://github.com/bernardcooke53/python-semantic-release/commit/1e860e8a4d9ec580449a0b87be9660a9482fa2a4))
...
* 0.3.0 ([`d633a28`](https://github.com/bernardcooke53/python-semantic-release/commit/d633a2811f2e14581793ebdf08b852dc6024dd44))

* Add info about tagging in readme ([`914c78f`](https://github.com/bernardcooke53/python-semantic-release/commit/914c78f0e1e15043c080e6d1ee56eccb5a70dd7d))

* :sparkles: Add support for tagging releases ([`5f4736f`](https://github.com/bernardcooke53/python-semantic-release/commit/5f4736f4e41bc96d36caa76ca58be0e1e7931069))

* :bug: Fix issue with committing the same version # ([`441798a`](https://github.com/bernardcooke53/python-semantic-release/commit/441798a223195138c0d3d2c51fc916137fef9a6c))

* Remove patch as default for untagged history ([`e44e2a1`](https://github.com/bernardcooke53/python-semantic-release/commit/e44e2a166033b75f75351825f7e4e0866bb7c45b))

* Restructure and add tests ([`4546e1e`](https://github.com/bernardcooke53/python-semantic-release/commit/4546e1e11429026c1a5410e17f8c5f866cfe5833))
...
* 0.2.0 ([`c3bad90`](https://github.com/bernardcooke53/python-semantic-release/commit/c3bad90b53cc3312795da18881e6405d9cb8cdfc))

* Remove apt dependencies from frigg settings ([`d942a32`](https://github.com/bernardcooke53/python-semantic-release/commit/d942a32bd475b3541c207069bd43d88f60a310a0))

* Fix get_commit_log ([`9af798a`](https://github.com/bernardcooke53/python-semantic-release/commit/9af798abab0d0b69c36134f0189745e9703dbfba))

* Remove pygit2 and add gitpython ([`8165a2e`](https://github.com/bernardcooke53/python-semantic-release/commit/8165a2eef2c6eea88bfa52e6db37abc7374cccba))

* Add test to check which parts of the git log is considered ([`bb384b1`](https://github.com/bernardcooke53/python-semantic-release/commit/bb384b16d649ed2bb0f30cd3356c0e78f6e06e11))

* :sparkles: Add noop mode

Fixes #4 ([`44c2039`](https://github.com/bernardcooke53/python-semantic-release/commit/44c203989aabc9366ba42ed2bc40eaccd7ac891c))

* Add docstrings in cli ([`315f6d2`](https://github.com/bernardcooke53/python-semantic-release/commit/315f6d2e3c80c309e80733234ab123d07c10779d))

* Add installation of python3-cffi to frigg settings ([`aa38ca8`](https://github.com/bernardcooke53/python-semantic-release/commit/aa38ca8c5c64a583ecc4fb78c4789a18a031ceae))

* Add installation of libgit2-dev in frigg settings ([`ff1d72b`](https://github.com/bernardcooke53/python-semantic-release/commit/ff1d72b8f4a8e55317d3f3b0efebaeaf67fb8f63))

* Remove the this is not usable yet warning from readme ([`b14b468`](https://github.com/bernardcooke53/python-semantic-release/commit/b14b468f96211fd754f7441b8c8ca371e9cd5ce1))

* Update usage docs in readme ([`1f753e6`](https://github.com/bernardcooke53/python-semantic-release/commit/1f753e631b9b7e9d4234779ddaac31532ed77b88))

* Remove note about :arrow_up: in readme ([`1554051`](https://github.com/bernardcooke53/python-semantic-release/commit/1554051d9e061094bc191812348c32c22d3d5f40))

* Update config docs in readme ([`06a261f`](https://github.com/bernardcooke53/python-semantic-release/commit/06a261f14426c43713bb9ec32a87066ce2adb010))
...
* 0.1.1 ([`54a98fe`](https://github.com/bernardcooke53/python-semantic-release/commit/54a98fedbf5f8a3898d0d9c27bca20e9b8a382e5))

* Fix libgit install in frigg settings ([`bd991c3`](https://github.com/bernardcooke53/python-semantic-release/commit/bd991c3b3e1f69f86b1f6ca538e57b3ba365e376))

* :bug: Fix entry point ([`bd7ce7f`](https://github.com/bernardcooke53/python-semantic-release/commit/bd7ce7f47c49e2027767fb770024a0d4033299fa))

* Fix badges ([`1e5df79`](https://github.com/bernardcooke53/python-semantic-release/commit/1e5df79aa104768078e6e66d559ab88b751cc0a3))

* Add libgit2 to frigg settings ([`d55f25c`](https://github.com/bernardcooke53/python-semantic-release/commit/d55f25cac13625037c5154e3cdd7dbb9bb88e350))

* Update readme ([`e8a6dd9`](https://github.com/bernardcooke53/python-semantic-release/commit/e8a6dd9e264a3e2d4186c323f7b544d4e42754b1))
...
* 0.1.0 ([`30d5f43`](https://github.com/bernardcooke53/python-semantic-release/commit/30d5f4376dc540548f68da921bd87ae7b21e7996))

* Add commiting of new version ([`6865d4b`](https://github.com/bernardcooke53/python-semantic-release/commit/6865d4b9d39027effe1902b9c50479c832650f68))

* Add detection of change level ([`06c5ac4`](https://github.com/bernardcooke53/python-semantic-release/commit/06c5ac4ce945223452c1331371c74130a2fc4b49))

* Fix coverage settings ([`4b80fab`](https://github.com/bernardcooke53/python-semantic-release/commit/4b80fab7433a215c09a68b041fef9db2286f8428))

* :sparkles: Implement setting of new version ([`a2ad75b`](https://github.com/bernardcooke53/python-semantic-release/commit/a2ad75b8dac515d1bbc49c32257c62a7da59e2e1))

* :sparkles: Add loading of config ([`51c5e93`](https://github.com/bernardcooke53/python-semantic-release/commit/51c5e93adf2c4d4193d94cce2b661da7fb75138e))

* Fix readme badges ([`a3cc59b`](https://github.com/bernardcooke53/python-semantic-release/commit/a3cc59b3471294ed0875624889dfde8cf8c6402f))

* Update readme ([`2b64782`](https://github.com/bernardcooke53/python-semantic-release/commit/2b64782e3fd78aec1e9f8d8cd391efc8eb3a4416))

* Fix isort ([`11feb93`](https://github.com/bernardcooke53/python-semantic-release/commit/11feb93c23c2bb51480191c5035fa92a7316e546))

* :sparkles: Add better force options ([`c6b4fe9`](https://github.com/bernardcooke53/python-semantic-release/commit/c6b4fe999531516ff5657541e894c3156deffbcb))

* Remove print usage ([`5ca8957`](https://github.com/bernardcooke53/python-semantic-release/commit/5ca8957b3974fdfa46fb66199f5848aa2711a49e))

* :sparkles: Implement get_new_version with semver ([`4bb1f10`](https://github.com/bernardcooke53/python-semantic-release/commit/4bb1f10fba27256a4982ad2ff4e2478ace7893a7))

* :sparkles: Implement get_current_version ([`49de531`](https://github.com/bernardcooke53/python-semantic-release/commit/49de531900b8d3cde4ae36d1f58f26da196e8177))

* :sparkles: Add basic cli interface ([`ff03d6e`](https://github.com/bernardcooke53/python-semantic-release/commit/ff03d6e796ffee498e21c1457fd1c356418cc5e6))

* :sparkles: Add project structure ([`57f4c2b`](https://github.com/bernardcooke53/python-semantic-release/commit/57f4c2bdbfe88f6318c87bf6b2fbf851bc9f5a90))

* Add a plan to the readme ([`6f87d66`](https://github.com/bernardcooke53/python-semantic-release/commit/6f87d6691f95c6dd652ba5fdadf155e9a194bfb6))

* Initial commit ([`94abb4e`](https://github.com/bernardcooke53/python-semantic-release/commit/94abb4e631d363f1f7ffcf85f026fc57845d4c1c))
