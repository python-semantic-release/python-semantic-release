...
@mock.patch(
    "semantic_release.history.logs.get_commit_log", lambda *a, **kw: [MINOR]
)
...
@mock.patch(
    "semantic_release.history.logs.get_commit_log", lambda *a, **kw: [NO_TAG]
)
...
def test_version_bump_maintains_formatting():
    ...
    assert replace_version_string("version = '1.2.3'", "version", "1.2.4") == "version = '1.2.4'"
