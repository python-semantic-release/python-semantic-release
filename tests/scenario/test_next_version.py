...
from tests.fixtures.repos.repo_initial_commit import repo_w_initial_commit
    ...
    xdist_sort_hack(
        [
            (
                ...
                lazy_fixture(default_angular_parser.__name__),
    ...
    xdist_sort_hack(
        [
            (
                ...
                lazy_fixture(default_emoji_parser.__name__),
                VersionTranslator(prerelease_token="alpha"),
    ...
    xdist_sort_hack(
        [
            (
                ...
                lazy_fixture(default_scipy_parser.__name__),
                VersionTranslator(prerelease_token="alpha"),
                ...
                for (repo_fixture_name, parser_fixture_name, translator), values in {
                    ...
                    (
                        ...
                        *(
                        ...
                        # (lazy_fixture(scipy_minor_commits.__name__), False, "1.2.0"), # used as default
                        (
                            lazy_fixture(scipy_minor_commits.__name__),
                            True,
                            "1.2.0-alpha.3",
