...
def get_repo_definition_4_github_flow_monorepo_w_default_release_channel(
    ...
    ```
    * chore(release): pkg-1@1.1.0 [skip ci] (tag: pkg1-v1.1.0)
    * feat(pkg1): file modified outside of pkg 1, identified by scope (#5)
    ...
    |/
    * chore(release): pkg-2@1.1.1 [skip ci] (HEAD -> main, tag: pkg2-v1.1.1)
    * fix(pkg2-cli): file modified outside of pkg 2, identified by scope (#4)
    ...
    |/
    * chore(release): pkg-2@1.1.0 [skip ci] (tag: pkg2-v1.1.0)
    * feat: no pkg scope but file in pkg 2 directory  (#3)                   # Squash merge of pkg2/feat/pr-2
    * chore(release): pkg-1@1.0.1 [skip ci] (tag: pkg1-v1.0.1)
    * fix: no pkg scope but file in pkg 1 directory  (#2)                    # Squash merge of pkg1/fix/pr-1
    ...
    |/
    * chore(release): pkg-2@1.0.0 [skip ci] (tag: pkg2-v1.0.0)          # Initial release of pkg 2
    * chore(release): pkg-1@1.0.0 [skip ci] (tag: pkg1-v1.0.0)          # Initial release of pkg 1
    * Initial commit                                                    # Includes core functionality for both packages
    ...
    def _get_repo_from_definition(
                    ...
                    "post_actions": [
                        {
                            ...
                            "details": {
                                ...
                                "tag_format_str": (
                                    pkg1_tag_format_str
                                    := f"{monorepo_pkg1_name}-{tag_format_str}"
                                ),
                        ...
                        },
                        {
                            ...
                            "details": {
                                ...
                                "tag_format_str": (
                                    pkg2_tag_format_str
                                    := f"{monorepo_pkg2_name}-{tag_format_str}"
                                ),
                                "mask_initial_release": mask_initial_release,
                                "extra_configs": {
                                    **common_configs,
        ...
        pkg1_new_version = Version.parse("1.0.0", tag_format=pkg1_tag_format_str)
        pkg2_new_version = Version.parse("1.0.0", tag_format=pkg2_tag_format_str)
            ...
            [
                {
                    ...
                    "details": {
                        ...
                        "datetime": next(commit_timestamp_gen),
                        "tag_format": pkg1_tag_format_str,
                ...
                },
                {
                    ...
                    "details": {
                        ...
                        "datetime": next(commit_timestamp_gen),
                        "tag_format": pkg2_tag_format_str,
        ...
        pkg1_new_version = Version.parse("1.0.1", tag_format=pkg1_tag_format_str)
        ...
        pkg2_new_version = Version.parse("1.1.0", tag_format=pkg2_tag_format_str)
        ...
        pkg2_new_version = Version.parse("1.1.1", tag_format=pkg2_tag_format_str)
        ...
        pkg1_new_version = Version.parse("1.1.0", tag_format=pkg1_tag_format_str)
