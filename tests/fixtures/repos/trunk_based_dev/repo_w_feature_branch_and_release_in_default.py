...
def deps_files_4_repo_w_feature_branch_and_release_in_default(
...
@pytest.fixture(scope="session")
def build_spec_hash_4_repo_w_feature_branch_and_release_in_default(
    get_md5_for_set_of_files: GetMd5ForSetOfFilesFn,
    deps_files_4_repo_w_feature_branch_and_release_in_default: list[Path],
) -> str:
    # Generates a hash of the build spec to set when to invalidate the cache
    return get_md5_for_set_of_files(
        deps_files_4_repo_w_feature_branch_and_release_in_default
    )


@pytest.fixture(scope="session")
def get_repo_definition_4_trunk_only_repo_w_feature_branch_and_release_in_default(
...
@pytest.fixture(scope="session")
def build_trunk_only_repo_w_feature_branch_and_release_in_default(
    build_repo_from_definition: BuildRepoFromDefinitionFn,
    get_repo_definition_4_trunk_only_repo_w_feature_branch_and_release_in_default: GetRepoDefinitionFn,
    get_cached_repo_data: GetCachedRepoDataFn,
    build_repo_or_copy_cache: BuildRepoOrCopyCacheFn,
    build_spec_hash_4_repo_w_feature_branch_and_release_in_default: str,
) -> BuildSpecificRepoFn:
    def _build_specific_repo_type(
        ...
        build_repo_or_copy_cache(
            repo_name=repo_name,
            build_spec_hash=build_spec_hash_4_repo_w_feature_branch_and_release_in_default,
...
@pytest.fixture
def repo_w_trunk_only_w_feature_branch_and_release_in_default_conventional_commits(
    build_trunk_only_repo_w_feature_branch_and_release_in_default: BuildSpecificRepoFn,
    example_project_git_repo: ExProjectGitRepoFn,
    example_project_dir: ExProjectDir,
    change_to_ex_proj_dir: None,
) -> BuiltRepoResult:
    repo_name = repo_w_trunk_only_w_feature_branch_and_release_in_default_conventional_commits.__name__
    commit_type: CommitConvention = repo_name.split("_")[-2]  # type: ignore[assignment]

    return {
        "definition": build_trunk_only_repo_w_feature_branch_and_release_in_default(
            repo_name=repo_name,
            commit_type=commit_type,
...
@pytest.fixture
def repo_w_trunk_only_w_feature_branch_and_release_in_default_emoji_commits(
    build_trunk_only_repo_w_feature_branch_and_release_in_default: BuildSpecificRepoFn,
    example_project_git_repo: ExProjectGitRepoFn,
    example_project_dir: ExProjectDir,
    change_to_ex_proj_dir: None,
...
@pytest.fixture
def repo_w_trunk_only_w_feature_branch_and_release_in_default_scipy_commits(
    build_trunk_only_repo_w_feature_branch_and_release_in_default: BuildSpecificRepoFn,
    example_project_git_repo: ExProjectGitRepoFn,
    example_project_dir: ExProjectDir,
    change_to_ex_proj_dir: None,
