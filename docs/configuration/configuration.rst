...
*Default changed to ``false`` in 10.0.0*
...
*Default changed to ``true`` in 10.0.0.*
...
*Introduced in v9.10.0. Default changed to `update` in 10.0.0.*
...
2. The variable name defined by ``variable`` and the version must be separated by
   ...
   the symbol. As of 10.0.0, a double-equals (``==``) operator is also supported
